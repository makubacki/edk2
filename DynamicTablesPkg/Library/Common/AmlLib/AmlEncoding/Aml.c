...
AML_BYTE_ENCODING  mAmlByteEncoding[] = {
  ...
  /* 0x5B 0x01 */                                                   {
    AML_OPCODE_DEF ("MutexOp",           AML_EXT_OP),
    AML_EXT_MUTEX_OP,                                 2,
    0,
    { EAmlName,  EAmlUInt8,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x02 */                                                   {
    AML_OPCODE_DEF ("EventOp",           AML_EXT_OP),
    AML_EXT_EVENT_OP,                                 1,
    0,
    { EAmlName,  EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x12 */                                                   {
    AML_OPCODE_DEF ("CondRefOfOp",       AML_EXT_OP),
    AML_EXT_COND_REF_OF_OP,                           2,
    0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone                                                                                                                                                                                                                                                                                                                      },
  ...
  /* 0x5B 0x13 */                                                   {
    AML_OPCODE_DEF ("CreateFieldOp",     AML_EXT_OP),
    AML_EXT_CREATE_FIELD_OP,                           4,
    3,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlName,
  ...
  /* 0x5B 0x1F */                                                   {
    AML_OPCODE_DEF ("LoadTableOp",       AML_EXT_OP),
    AML_EXT_LOAD_TABLE_OP,                             6,
    0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlObject,
  ...
  /* 0x5B 0x20 */                                                   {
    AML_OPCODE_DEF ("LoadOp",            AML_EXT_OP),
    AML_EXT_LOAD_OP,                                   2,
    0,
    { EAmlName,  EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x21 */                                                   {
    AML_OPCODE_DEF ("StallOp",           AML_EXT_OP),
    AML_EXT_STALL_OP,                                  1,
    0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x22 */                                                   {
    AML_OPCODE_DEF ("SleepOp",           AML_EXT_OP),
    AML_EXT_SLEEP_OP,                                  1,
    0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x23 */                                                   {
    AML_OPCODE_DEF ("AcquireOp",         AML_EXT_OP),
    AML_EXT_ACQUIRE_OP,                                 2,
    0,
    { EAmlObject, EAmlUInt16,
                                                                      EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone                                                                                                                                                                                                                                                                                                                                                                },
  ...
  /* 0x5B 0x24 */                                                   {
    AML_OPCODE_DEF ("SignalOp",          AML_EXT_OP),
    AML_EXT_SIGNAL_OP,                                  1,
    0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x25 */                                                   {
    AML_OPCODE_DEF ("WaitOp",            AML_EXT_OP),
    AML_EXT_WAIT_OP,                                    2,
    0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x26 */                                                   {
    AML_OPCODE_DEF ("ResetOp",           AML_EXT_OP),
    AML_EXT_RESET_OP,                                   1,
    0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x27 */                                                   {
    AML_OPCODE_DEF ("ReleaseOp",         AML_EXT_OP),
    AML_EXT_RELEASE_OP,                                 1,
    0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x28 */                                                   {
    AML_OPCODE_DEF ("FromBCDOp",         AML_EXT_OP),
    AML_EXT_FROM_BCD_OP,                                2,
    0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x29 */                                                   {
    AML_OPCODE_DEF ("ToBCDOp",           AML_EXT_OP),
    AML_EXT_TO_BCD_OP,                                  2,
    0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x2A */                                                   {
    AML_OPCODE_DEF ("UnloadOp",          AML_EXT_OP),
    AML_EXT_UNLOAD_OP,                                  1,
    0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x30 */                                                   {
    AML_OPCODE_DEF ("RevisionOp",        AML_EXT_OP),
    AML_EXT_REVISION_OP,                                0,
    0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x31 */                                                   {
    AML_OPCODE_DEF ("DebugOp",           AML_EXT_OP),
    AML_EXT_DEBUG_OP,                                   0,
    0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x32 */                                                   {
    AML_OPCODE_DEF ("FatalOp",           AML_EXT_OP),
    AML_EXT_FATAL_OP,                                   3,
    0,
    { EAmlUInt8, EAmlUInt32,
                                                                      EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone                                                                                                                                                                                                                                                                                                                                                                                                                                      },
  ...
  /* 0x5B 0x33 */                                                   {
    AML_OPCODE_DEF ("TimerOp",           AML_EXT_OP),
    AML_EXT_TIMER_OP,                                   0,
    0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x80 */                                                   {
    AML_OPCODE_DEF ("OpRegionOp",        AML_EXT_OP),
    AML_EXT_REGION_OP,                                  4,
    0,
    { EAmlName,  EAmlUInt8,
                                                                      EAmlObject,
  ...
  /* 0x5B 0x81 */                                                   {
    AML_OPCODE_DEF ("FieldOp",           AML_EXT_OP),
    AML_EXT_FIELD_OP,                                   2,
    0,
    { EAmlName,  EAmlUInt8,
                                                                      EAmlNone,
                                                                      ...
                                                                      EAmlNone,
                                                                      EAmlNone                                                                                                                                                                                                                                                                                                                                                                                                                                                           },
    AML_HAS_PKG_LENGTH | AML_HAS_FIELD_LIST
  },
  /* 0x5B 0x82 */                                                   {
    AML_OPCODE_DEF ("DeviceOp",          AML_EXT_OP),
    AML_EXT_DEVICE_OP,                                  1,
    0,
    { EAmlName,  EAmlNone,
                                                                      EAmlNone,
                                                                      ...
                                                                      EAmlNone,
                                                                      EAmlNone                                                                                                                                                                                                                                                                                                                                                                                                                                                                  },
    AML_HAS_PKG_LENGTH | AML_HAS_CHILD_OBJ | AML_IN_NAMESPACE
  },
  /* 0x5B 0x83 */                                                   {
    AML_OPCODE_DEF ("ProcessorOp",       AML_EXT_OP),
    AML_EXT_PROCESSOR_OP,                               4,
    0,
    { EAmlName,  EAmlUInt8,
                                                                      EAmlUInt32,
                                                                      EAmlUInt8,
  ...
  /* 0x5B 0x84 */                                                   {
    AML_OPCODE_DEF ("PowerResOp",        AML_EXT_OP),
    AML_EXT_POWER_RES_OP,                               3,
    0,
    { EAmlName,  EAmlUInt8,
                                                                      EAmlUInt16,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x85 */                                                   {
    AML_OPCODE_DEF ("ThermalZoneOp",     AML_EXT_OP),
    AML_EXT_THERMAL_ZONE_OP,                            1,
    0,
    { EAmlName,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x86 */                                                   {
    AML_OPCODE_DEF ("IndexFieldOp",      AML_EXT_OP),
    AML_EXT_INDEX_FIELD_OP,                            3,
    0,
    { EAmlName,  EAmlName,
                                                                      EAmlUInt8,
                                                                      EAmlNone,
  ...
  /* 0x5B 0x87 */                                                   {
    AML_OPCODE_DEF ("BankFieldOp",       AML_EXT_OP),
    AML_EXT_BANK_FIELD_OP,                             4,
    0,
    { EAmlName,  EAmlName,
                                                                      EAmlObject,
                                                                      EAmlUInt8,
  ...
  /* 0x5B 0x88 */                                                   {
    AML_OPCODE_DEF ("DataRegionOp",      AML_EXT_OP),
    AML_EXT_DATA_REGION_OP,                            4,
    0,
    { EAmlName,  EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlObject,
  ...
  /* 0x5C */                                                        {
    AML_OPCODE_DEF ("RootChar",          AML_ROOT_CHAR),
    0,                                   0,
    0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x5E */                                                        {
    AML_OPCODE_DEF ("ParentPrefixChar",  AML_PARENT_PREFIX_CHAR),
    0,                                   0,                                   0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x60 */                                                        {
    AML_OPCODE_DEF ("Local0Op",          AML_LOCAL0),
    0,                              0,                                   0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x61 */                                                        {
    AML_OPCODE_DEF ("Local1Op",          AML_LOCAL1),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x62 */                                                        {
    AML_OPCODE_DEF ("Local2Op",          AML_LOCAL2),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x63 */                                                        {
    AML_OPCODE_DEF ("Local3Op",          AML_LOCAL3),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x64 */                                                        {
    AML_OPCODE_DEF ("Local4Op",          AML_LOCAL4),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x65 */                                                        {
    AML_OPCODE_DEF ("Local5Op",          AML_LOCAL5),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x66 */                                                        {
    AML_OPCODE_DEF ("Local6Op",          AML_LOCAL6),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x67 */                                                        {
    AML_OPCODE_DEF ("Local7Op",          AML_LOCAL7),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x68 */                                                        {
    AML_OPCODE_DEF ("Arg0Op",            AML_ARG0),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x69 */                                                        {
    AML_OPCODE_DEF ("Arg1Op",            AML_ARG1),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x6A */                                                        {
    AML_OPCODE_DEF ("Arg2Op",            AML_ARG2),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x6B */                                                        {
    AML_OPCODE_DEF ("Arg3Op",            AML_ARG3),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x6C */                                                        {
    AML_OPCODE_DEF ("Arg4Op",            AML_ARG4),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x6D */                                                        {
    AML_OPCODE_DEF ("Arg5Op",            AML_ARG5),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x6E */                                                        {
    AML_OPCODE_DEF ("Arg6Op",            AML_ARG6),
    0,                              0,                              0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x70 */                                                        {
    AML_OPCODE_DEF ("StoreOp",           AML_STORE_OP),
    0,                             2,                              0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x71 */                                                        {
    AML_OPCODE_DEF ("RefOfOp",           AML_REF_OF_OP),
    0,                             1,                             0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x72 */                                                        {
    AML_OPCODE_DEF ("AddOp",             AML_ADD_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x73 */                                                        {
    AML_OPCODE_DEF ("ConcatOp",          AML_CONCAT_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x74 */                                                        {
    AML_OPCODE_DEF ("SubtractOp",        AML_SUBTRACT_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x75 */                                                        {
    AML_OPCODE_DEF ("IncrementOp",       AML_INCREMENT_OP),
    0,                             1,                             0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x76 */                                                        {
    AML_OPCODE_DEF ("DecrementOp",       AML_DECREMENT_OP),
    0,                             1,                             0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x77 */                                                        {
    AML_OPCODE_DEF ("MultiplyOp",        AML_MULTIPLY_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x78 */                                                        {
    AML_OPCODE_DEF ("DivideOp",          AML_DIVIDE_OP),
    0,                             4,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlObject,
  ...
  /* 0x79 */                                                        {
    AML_OPCODE_DEF ("ShiftLeftOp",       AML_SHIFT_LEFT_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x7A */                                                        {
    AML_OPCODE_DEF ("ShiftRightOp",      AML_SHIFT_RIGHT_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x7B */                                                        {
    AML_OPCODE_DEF ("AndOp",             AML_AND_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x7C */                                                        {
    AML_OPCODE_DEF ("NAndOp",            AML_NAND_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x7E */                                                        {
    AML_OPCODE_DEF ("NorOp",             AML_NOR_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x7F */                                                        {
    AML_OPCODE_DEF ("XOrOp",             AML_XOR_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x80 */                                                        {
    AML_OPCODE_DEF ("NotOp",             AML_NOT_OP),
    0,                             2,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x81 */                                                        {
    AML_OPCODE_DEF ("FindSetLeftBitOp",  AML_FIND_SET_LEFT_BIT_OP),
    0,                             2,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x82 */                                                        {
    AML_OPCODE_DEF ("FindSetRightBitOp", AML_FIND_SET_RIGHT_BIT_OP),
    0,                             2,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x83 */                                                        {
    AML_OPCODE_DEF ("DerefOfOp",         AML_DEREF_OF_OP),
    0,                             1,                             0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x84 */                                                        {
    AML_OPCODE_DEF ("ConcatResOp",       AML_CONCAT_RES_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x85 */                                                        {
    AML_OPCODE_DEF ("ModOp",             AML_MOD_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x86 */                                                        {
    AML_OPCODE_DEF ("NotifyOp",          AML_NOTIFY_OP),
    0,                             2,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x87 */                                                        {
    AML_OPCODE_DEF ("SizeOfOp",          AML_SIZE_OF_OP),
    0,                             1,                             0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x88 */                                                        {
    AML_OPCODE_DEF ("IndexOp",           AML_INDEX_OP),
    0,                             3,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x89 */                                                        {
    AML_OPCODE_DEF ("MatchOp",           AML_MATCH_OP),
    0,                             6,                             0,
    { EAmlObject, EAmlUInt8,
                                                                      EAmlObject,
                                                                      EAmlUInt8,
                                                                      EAmlObject,
                                                                      EAmlObject                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            },
  ...
  /* 0x8A */                                                        {
    AML_OPCODE_DEF ("CreateDWordFieldOp", AML_CREATE_DWORD_FIELD_OP),
    0,                             3,                             2,
    { EAmlObject, EAmlObject,
                                                                      EAmlName,
                                                                      EAmlNone,
  ...
  /* 0x8B */                                                        {
    AML_OPCODE_DEF ("CreateWordFieldOp", AML_CREATE_WORD_FIELD_OP),
    0,                             3,                             2,
    { EAmlObject, EAmlObject,
                                                                      EAmlName,
                                                                      EAmlNone,
  ...
  /* 0x8C */                                                        {
    AML_OPCODE_DEF ("CreateByteFieldOp", AML_CREATE_BYTE_FIELD_OP),
    0,                             3,                             2,
    { EAmlObject, EAmlObject,
                                                                      EAmlName,
                                                                      EAmlNone,
  ...
  /* 0x8D */                                                        {
    AML_OPCODE_DEF ("CreateBitFieldOp",  AML_CREATE_BIT_FIELD_OP),
    0,                             3,                             2,
    { EAmlObject, EAmlObject,
                                                                      EAmlName,
                                                                      EAmlNone,
  ...
  /* 0x8E */                                                        {
    AML_OPCODE_DEF ("ObjectTypeOp",      AML_OBJECT_TYPE_OP),
    0,                             1,                             0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x8F */                                                        {
    AML_OPCODE_DEF ("CreateQWordFieldOp", AML_CREATE_QWORD_FIELD_OP),
    0,                             3,                             2,
    { EAmlObject, EAmlObject,
                                                                      EAmlName,
                                                                      EAmlNone,
  ...
  /* 0x90 */                                                        {
    AML_OPCODE_DEF ("LAndOp",           AML_LAND_OP),
    0,                             2,                             0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x98 */                                                        {
    AML_OPCODE_DEF ("ToHexStringOp", AML_TO_HEX_STRING_OP),               0,
    2,                            0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x99 */                                                        {
    AML_OPCODE_DEF ("ToIntegerOp",  AML_TO_INTEGER_OP),               0,
    2,                            0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x9C */                                                        {
    AML_OPCODE_DEF ("ToStringOp",   AML_TO_STRING_OP),                0,
    3,                            0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x9D */                                                        {
    AML_OPCODE_DEF ("CopyObjectOp", AML_COPY_OBJECT_OP),              0,
    2,                        0,
    { EAmlObject, EAmlObject,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0x9E */                                                        {
    AML_OPCODE_DEF ("MidOp",        AML_MID_OP),                      0,
    3,                        0,
    { EAmlObject, EAmlObject,
                                                                      EAmlObject,
                                                                      EAmlNone,
  ...
  /* 0x9F */                                                        {
    AML_OPCODE_DEF ("ContinueOp",   AML_CONTINUE_OP),                 0,
    0,                        0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0xA0 */                                                        {
    AML_OPCODE_DEF ("IfOp",         AML_IF_OP),                       0,
    1,                        0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0xA1 */                                                        {
    AML_OPCODE_DEF ("ElseOp",       AML_ELSE_OP),                     0,
    0,                        0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0xA2 */                                                        {
    AML_OPCODE_DEF ("WhileOp",      AML_WHILE_OP),                    0,
    1,                      0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0xA3 */                                                        {
    AML_OPCODE_DEF ("NoopOp",       AML_NOOP_OP),                     0,
    0,                      0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0xA4 */                                                        {
    AML_OPCODE_DEF ("ReturnOp",     AML_RETURN_OP),                   0,
    1,                      0,
    { EAmlObject, EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0xA5 */                                                        {
    AML_OPCODE_DEF ("BreakOp",      AML_BREAK_OP),                    0,
    0,                      0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0xCC */                                                        {
    AML_OPCODE_DEF ("BreakPointOp", AML_BREAK_POINT_OP),              0,
    0,                      0,
    { EAmlNone,  EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
  ...
  /* 0xD0 */                                                        {
    AML_OPCODE_DEF ("MethodInvocOp", AML_METHOD_INVOC_OP),            0,
    2,                      0,
    { EAmlName,  EAmlUInt8,   EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone,
                                                                      EAmlNone                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      },
    AML_IS_PSEUDO_OPCODE | AML_HAS_CHILD_OBJ
  },
  /* 0xFF */                                                        {
    AML_OPCODE_DEF ("OnesOp", AML_ONES_OP),                    0,
    0,                      0,
    { EAmlNone,  EAmlNone,    EAmlNone,    EAmlNone,EAmlNone,
                                                                      EAmlNone                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         },
    0
  },
};
...
AML_BYTE_ENCODING  mAmlFieldEncoding[] = {
  // Comment                       Str                    OpCode                     SubOpCode               MaxIndex  NameIndex   0                 1                 2                 3                 4                 5                 Attribute
  /* 0x00 */           { AML_OPCODE_DEF ("FieldReservedOp",
                         ...
                         AML_HAS_PKG_LENGTH                      },
  /* 0x01 */           { AML_OPCODE_DEF ("FieldAccessOp",  AML_FIELD_ACCESS_OP),
                         0,         2,                0,
                         { EAmlUInt8,                        EAmlUInt8,
                         EAmlNone, EAmlNone,
                         EAmlNone,
  ...
  /* 0x03 */           { AML_OPCODE_DEF (
                         ...
                         EAmlNone                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  },
                         AML_IS_FIELD_ELEMENT                                           },
  /* 0x04 */           { AML_OPCODE_DEF ("FieldNamed",     AML_FIELD_NAMED_OP),
                         0,                 2,                0,
                         { EAmlName,                         EAmlFieldPkgLen,
                         EAmlNone, EAmlNone, EAmlNone,
                         EAmlNone                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           },
                         AML_IS_FIELD_ELEMENT | AML_IS_PSEUDO_OPCODE |
                         AML_IN_NAMESPACE }
};
