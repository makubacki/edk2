  ...
  )
{
  ...
  if (PcdGet32 (PcdFspmUpdDataAddress) == 0 && (FspmHeaderPtr->CfgRegionSize != 0) &&
  ...
  DEBUG (
        (DEBUG_INFO, "Total time spent executing FspMemoryInitApi: %d millisecond\n",
  ...
  )
{
  ...
  MeasurementExcludedFvPpi->Fv[0].FvLength =
    ((EFI_FIRMWARE_VOLUME_HEADER *) (UINTN) PcdGet32 (PcdFspmBaseAddress))->FvLength;
