...
struct _MTFTP4_SERVICE {
  ...
  EFI_EVENT                       Timer;            ///< Ticking timer for all the MTFTP clients to handle the packet
                                                    ///< timeout case.
  EFI_EVENT                       TimerNotifyLevel; ///< Ticking timer for all the MTFTP clients to calculate the packet
                                                    ///< live time.
