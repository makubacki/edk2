  ...
  *Completed = TRUE;
  ...
  if (Instance->Service->IpVersion == IP_VERSION_4) {
    ...
    if (Dns4TokenEntry->GeneralLookUp) {
      ...
      Dns4TokenEntry->Token->RspData.GLookupData->RRList =
        AllocateZeroPool (DnsHeader->AnswersNum * sizeof (DNS_RESOURCE_RECORD));
      ...
      if (QuerySection->Type == DNS_TYPE_A) {
        ...
        Dns4TokenEntry->Token->RspData.H2AData->IpList =
          AllocateZeroPool (DnsHeader->AnswersNum * sizeof (EFI_IPv4_ADDRESS));
    ...
    if (Dns6TokenEntry->GeneralLookUp) {
      ...
      if (QuerySection->Type == DNS_TYPE_AAAA) {
        ...
        Dns6TokenEntry->Token->RspData.H2AData->IpList =
          AllocateZeroPool (DnsHeader->AnswersNum * sizeof (EFI_IPv6_ADDRESS));
