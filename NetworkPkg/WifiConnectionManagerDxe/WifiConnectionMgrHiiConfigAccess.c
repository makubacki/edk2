      ...
      case KEY_SAVE_PRIVATE_KEY_TO_MEM:
        ...
        if (Private->FileContext != NULL && Private->FileContext->FHandle != NULL &&
          ...
          if (EFI_ERROR (Status)) {
            ...
            DEBUG (
                   (DEBUG_INFO, "[WiFi Connection Manager] Private Key: %s has been enrolled! Size: %d\n",
        ...
        if (Private->FileContext != NULL && Private->FileContext->FHandle != NULL &&
          ...
          if (EFI_ERROR (Status)) {
            ...
            if (Private->FileType == FileTypeCACert) {
              ...
              DEBUG (
                     (DEBUG_INFO, "[WiFi Connection Manager] CA Cert: %s has been enrolled! Size: %d\n",
              ...
              DEBUG (
                     (DEBUG_INFO, "[WiFi Connection Manager] Client Cert: %s has been enrolled! Size: %d\n",
