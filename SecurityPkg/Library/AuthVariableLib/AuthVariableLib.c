...
EFI_GUID  mSignatureSupport[] = {
  EFI_CERT_SHA1_GUID, EFI_CERT_SHA256_GUID, EFI_CERT_RSA2048_GUID,
  EFI_CERT_X509_GUID
};
  ...
  )
{
  ...
  //
  mMaxCertDbSize = (UINT32)(mAuthVarLibContextIn->MaxAuthVariableSize -
  ...
  Status           = AuthServiceInternalFindVariable (
                       EFI_SECURE_BOOT_ENABLE_NAME,
                       &gEfiSecureBootEnableDisableGuid, (VOID **)&Data,
                       &DataSize);
  if (!EFI_ERROR (Status)) {
  ...
  //
  if ((SecureBootEnable == SECURE_BOOT_ENABLE) && (mPlatformMode ==
                                                   USER_MODE)) {
  ...
  //
  Status = AuthServiceInternalFindVariable (EFI_VENDOR_KEYS_NV_VARIABLE_NAME,
             &gEfiVendorKeysNvGuid, (VOID **)&Data, &DataSize);
  if (!EFI_ERROR (Status)) {
  ...
  mAuthVarAddressPointer[3]               =
    (VOID **)&(mAuthVarLibContextIn->FindVariable),
  mAuthVarAddressPointer[4] =
    (VOID **)&(mAuthVarLibContextIn->FindNextVariable),
  mAuthVarAddressPointer[5] =
    (VOID **)&(mAuthVarLibContextIn->UpdateVariable),
  mAuthVarAddressPointer[6] =
    (VOID **)&(mAuthVarLibContextIn->GetScratchBuffer),
  mAuthVarAddressPointer[7] =
    (VOID **)&(mAuthVarLibContextIn->CheckRemainingSpaceForConsistency),
  mAuthVarAddressPointer[8] =
    (VOID **)&(mAuthVarLibContextIn->AtRuntime),
