  ...
  )
{
  ...
  if (RecvBufferSize !=
      sizeof (TPM2_RESPONSE_HEADER) + sizeof (UINT16) + OutPublicSize + sizeof (UINT16) + NameSize + sizeof (UINT16) +
      QualifiedNameSize) {
    DEBUG (
          (DEBUG_ERROR,
           "Tpm2ReadPublic - RecvBufferSize %x Error - OutPublicSize %x, NameSize %x, QualifiedNameSize %x\n",
           RecvBufferSize,
           OutPublicSize, NameSize, QualifiedNameSize)
          );
    return EFI_DEVICE_ERROR;
  }
  ...
  WriteUnaligned32 (
                   ...
                   SwapBytes32 (ReadUnaligned32 ((UINT32 *) &OutPublic->publicArea.objectAttributes))
                   );
  ...
  switch (OutPublic->publicArea.type) {
    case TPM_ALG_KEYEDHASH:
      ...
      switch (OutPublic->publicArea.parameters.keyedHashDetail.scheme.scheme) {
        case TPM_ALG_HMAC:
          OutPublic->publicArea.parameters.keyedHashDetail.scheme.details.hmac.hashAlg =
            SwapBytes16 (ReadUnaligned16 ((UINT16 *) Buffer));
          Buffer += sizeof (UINT16);
          break;
        case TPM_ALG_XOR:
    ...
    case TPM_ALG_RSA:
      ...
      switch (OutPublic->publicArea.parameters.rsaDetail.scheme.scheme) {
        case TPM_ALG_RSASSA:
          OutPublic->publicArea.parameters.rsaDetail.scheme.details.rsassa.hashAlg =
            SwapBytes16 (ReadUnaligned16 ((UINT16 *) Buffer));
          Buffer += sizeof (UINT16);
          break;
        case TPM_ALG_RSAPSS:
          OutPublic->publicArea.parameters.rsaDetail.scheme.details.rsapss.hashAlg =
            SwapBytes16 (ReadUnaligned16 ((UINT16 *) Buffer));
          Buffer += sizeof (UINT16);
          break;
        case TPM_ALG_RSAES:
    ...
    case TPM_ALG_ECC:
      ...
      switch (OutPublic->publicArea.parameters.eccDetail.scheme.scheme) {
        case TPM_ALG_ECDSA:
          OutPublic->publicArea.parameters.eccDetail.scheme.details.ecdsa.hashAlg =
            SwapBytes16 (ReadUnaligned16 ((UINT16 *) Buffer));
          Buffer += sizeof (UINT16);
          break;
        case TPM_ALG_ECDAA:
          OutPublic->publicArea.parameters.eccDetail.scheme.details.ecdaa.hashAlg =
            SwapBytes16 (ReadUnaligned16 ((UINT16 *) Buffer));
          Buffer += sizeof (UINT16);
          break;
        case TPM_ALG_ECSCHNORR:
          OutPublic->publicArea.parameters.eccDetail.scheme.details.ecSchnorr.hashAlg =
            SwapBytes16 (ReadUnaligned16 ((UINT16 *) Buffer));
          Buffer += sizeof (UINT16);
          break;
        case TPM_ALG_ECDH:
      ...
      switch (OutPublic->publicArea.parameters.eccDetail.kdf.scheme) {
        ...
        case TPM_ALG_KDF1_SP800_108:
          OutPublic->publicArea.parameters.eccDetail.kdf.details.kdf1_sp800_108.hashAlg =
            SwapBytes16 (ReadUnaligned16 ((UINT16 *) Buffer));
          Buffer += sizeof (UINT16);
          break;
        case TPM_ALG_KDF1_SP800_56a:
          OutPublic->publicArea.parameters.eccDetail.kdf.details.kdf1_SP800_56a.hashAlg =
            SwapBytes16 (ReadUnaligned16 ((UINT16 *) Buffer));
          Buffer += sizeof (UINT16);
          break;
        case TPM_ALG_KDF2:
  ...
  switch (OutPublic->publicArea.type) {
    case TPM_ALG_KEYEDHASH:
      ...
      if(OutPublic->publicArea.unique.keyedHash.size > sizeof (TPMU_HA)) {
        DEBUG (
            (DEBUG_ERROR, "Tpm2ReadPublic - keyedHash.size error %x\n",
  ...
  CopyMem (
          Name->name,
          (UINT8 *) &RecvBuffer + sizeof (TPM2_RESPONSE_HEADER) + sizeof (UINT16) + OutPublicSize + sizeof (UINT16),
          NameSize
          );
  Name->size = NameSize;
  ...
  CopyMem (
          QualifiedName->name,
          (UINT8 *) &RecvBuffer + sizeof (TPM2_RESPONSE_HEADER) + sizeof (UINT16) + OutPublicSize + sizeof (UINT16) + NameSize +
          sizeof (UINT16),
          QualifiedNameSize
          );
