  ...
  )
{
  ...
  WriteUnaligned32 (
    (UINT32 *)((UINT8 *)ImageExeInfoEntry +
  ...
  )
{
  ...
  //
  ASSERT (
    Policy != QUERY_USER_ON_SECURITY_VIOLATION && Policy !=
                                               ...
                                               )))
  {
    ...
    if (WinCertificate->wCertificateType == WIN_CERT_TYPE_PKCS_SIGNED_DATA) {
      ...
      if (WinCertUefiGuid->Hdr.dwLength <= OFFSET_OF (
