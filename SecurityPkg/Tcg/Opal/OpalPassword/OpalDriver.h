...
typedef struct {
  ...
  TCG_LOCKING_FEATURE_DESCRIPTOR           LockingFeature;                // Locking Feature Descriptor retrieved from
                                                                          // performing a Level 0 Discovery
  UINT8                                    PasswordLength;
  UINT8                                    Password[OPAL_MAX_PASSWORD_SIZE];

  UINT32                                   EstimateTimeCost;
  BOOLEAN                                  SentBlockSID;                  // Check whether BlockSid command has been
                                                                          // sent.
} OPAL_DISK;
...
struct _OPAL_DRIVER_DEVICE {
  ...
  CHAR16                                   *Name16;                   ///< Allocated/freed by UEFI Filter Driver at
                                                                      ///< device creation/removal
  CHAR8                                    *NameZ;                    ///< Allocated/freed by UEFI Filter Driver at
                                                                      ///< device creation/removal
  UINT32                                   MediaId;                   ///< Required parameter for
                                                                      ///< EFI_STORAGE_SECURITY_COMMAND_PROTOCOL, from
                                                                      ///< BLOCK_IO_MEDIA
...
//
#define DRIVER_DEVICE_FROM_OPALDISK(OpalDiskPointer)  (OPAL_DRIVER_DEVICE *) (BASE_CR ( \
                                                                                  OpalDiskPointer, \
                                                                                  OPAL_DRIVER_DEVICE, \
                                                                                  OpalDisk \
                                                                                  ))
