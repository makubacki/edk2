  ...
  )
{
  ...
  DEBUG_CODE (
              ...
              DEBUG (
          (DEBUG_INFO, "  HPET_GENERAL_INTERRUPT_STATUS = 0x%016lx\n",
  ...
  DEBUG_CODE (
    ...
    DEBUG ((DEBUG_INFO, "HPET I/O APIC IRQ         = 0x%02x\n", mTimerIrq));
              ...
              DEBUG (
          (DEBUG_INFO, "HPET_TIMER%d_CONFIGURATION = 0x%016lx\n", mTimerIndex,
           HpetRead (HPET_TIMER_CONFIGURATION_OFFSET + mTimerIndex * HPET_TIMER_STRIDE))
          );
              DEBUG (
          (DEBUG_INFO, "HPET_TIMER%d_COMPARATOR    = 0x%016lx\n", mTimerIndex,
           HpetRead (HPET_TIMER_COMPARATOR_OFFSET    + mTimerIndex * HPET_TIMER_STRIDE))
          );
              DEBUG (
          (DEBUG_INFO, "HPET_TIMER%d_MSI_ROUTE     = 0x%016lx\n", mTimerIndex,
           HpetRead (HPET_TIMER_MSI_ROUTE_OFFSET     + mTimerIndex * HPET_TIMER_STRIDE))
          );
