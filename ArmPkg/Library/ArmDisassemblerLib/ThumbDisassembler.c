...
THUMB_INSTRUCTIONS  gOpThumb[] = {
  ...
  { "MOVS",   0x0000,      0xffc0, DATA_FORMAT5                },// LSL with imm5 == 0 is a MOVS, so this must go before
                                                   // LSL
      ...
      switch (gOpThumb[Index].AddressMode) {
        ...
        case POP_FORMAT:
          ...
          AsciiSPrint (
                    ...
                    Size - Offset,
                    " %a",
                    ThumbMRegList ((OpCode & 0xff) | ((OpCode & BIT8) == BIT8 ? BIT15 : 0))
                    );
          return;
        ...
        case PUSH_FORMAT:
          ...
          AsciiSPrint (
                    ...
                    Size - Offset,
                    " %a",
                    ThumbMRegList ((OpCode & 0xff) | ((OpCode & BIT8) == BIT8 ? BIT14 : 0))
                    );
          return;
