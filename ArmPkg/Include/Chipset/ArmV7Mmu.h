...
#define TTBR_MP_WRITE_BACK_NO_ALLOC  (TTBR_RGN_OUTER_WRITE_BACK_NO_ALLOC | TTBR_RGN_INNER_WRITE_BACK_NO_ALLOC | \
                                      TTBR_SHAREABLE)
#define TTBR_MP_NON_CACHEABLE        (TTBR_RGN_OUTER_NON_CACHEABLE | TTBR_RGN_INNER_NON_CACHEABLE)
#define TTBR_MP_WRITE_BACK_ALLOC     (TTBR_RGN_OUTER_WRITE_BACK_ALLOC | TTBR_RGN_INNER_WRITE_BACK_ALLOC | \
                                      TTBR_SHAREABLE)
...
#define TT_DESCRIPTOR_CONVERT_TO_PAGE_AP(Desc)                         ((((Desc) & TT_DESCRIPTOR_SECTION_AP_MASK) >> \
                                                                         6) & TT_DESCRIPTOR_PAGE_AP_MASK)
#define TT_DESCRIPTOR_CONVERT_TO_PAGE_NG(Desc)                         ((((Desc) & TT_DESCRIPTOR_SECTION_NG_MASK) >> \
                                                                         6) & TT_DESCRIPTOR_PAGE_NG_MASK)
#define TT_DESCRIPTOR_CONVERT_TO_PAGE_S(Desc)                          ((((Desc) & TT_DESCRIPTOR_SECTION_S_MASK) >> \
                                                                         6) & TT_DESCRIPTOR_PAGE_S_MASK)
#define TT_DESCRIPTOR_CONVERT_TO_PAGE_XN(Desc, IsLargePage)            ((IsLargePage) ? \
                                                                        ((((Desc) & TT_DESCRIPTOR_SECTION_XN_MASK) << \
                                                                          11) & TT_DESCRIPTOR_LARGEPAGE_XN_MASK) :    \
                                                                        ((((Desc) & TT_DESCRIPTOR_SECTION_XN_MASK) >> \
                                                                          4) & TT_DESCRIPTOR_PAGE_XN_MASK))
#define TT_DESCRIPTOR_CONVERT_TO_PAGE_CACHE_POLICY(Desc, IsLargePage)  (IsLargePage ? \
                                                                        (((Desc) & \
                                                                          TT_DESCRIPTOR_SECTION_CACHE_POLICY_MASK) & \
                                                                         TT_DESCRIPTOR_LARGEPAGE_CACHE_POLICY_MASK) : \
                                                                        (((((Desc) & (0x3 << 12)) >> \
                                                                           6) | (Desc & (0x3 << 2)))))

#define TT_DESCRIPTOR_CONVERT_TO_SECTION_AP(Desc)  ((((Desc) & TT_DESCRIPTOR_PAGE_AP_MASK) << \
                                                     6) & TT_DESCRIPTOR_SECTION_AP_MASK)
