...
#define TT_GET_ENTRY_FOR_ADDRESS(TranslationTable, Level, Address)  \
  ((UINTN) (TranslationTable) + \
   ((((UINTN) (Address) >> TT_ADDRESS_OFFSET_AT_LEVEL (Level)) & (BIT9-1)) * sizeof (UINT64)))
...
#define TTBR_BADDR_MASK  (0xFFFFFFFFFFFF)                      // The width of this field depends on the values in TxSZ.
                                                               // Addr occupies bottom 48bits
