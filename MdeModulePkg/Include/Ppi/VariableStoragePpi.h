/** @file
  This EDKII-specific Variable Storage PPI is used to abstract non-volatile media storage access details
  from the EDKII UEFI variable driver during the PEI phase.
