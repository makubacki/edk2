...
#define EFI_IFR_SPECIFICATION_VERSION  (UINT16)(((EFI_SYSTEM_TABLE_REVISION >> 16) << \
                                                 8) | \
                                                (((EFI_SYSTEM_TABLE_REVISION & 0xFFFF) / 10) << \
                                                 4) | ((EFI_SYSTEM_TABLE_REVISION & 0xFFFF) % 10))
...
#define FORM_BROWSER_CONFIG_REQUEST_FROM_LINK(a)            CR ( \
                                                              a, \
                                                              FORM_BROWSER_CONFIG_REQUEST, \
                                                              Link, \
                                                              FORM_BROWSER_CONFIG_REQUEST_SIGNATURE \
                                                              )
#define FORM_BROWSER_CONFIG_REQUEST_FROM_SAVE_FAIL_LINK(a)  CR ( \
                                                              a, \
                                                              FORM_BROWSER_CONFIG_REQUEST, \
                                                              SaveFailLink, \
                                                              FORM_BROWSER_CONFIG_REQUEST_SIGNATURE \
...
#define FORM_BROWSER_FORMSET_FROM_SAVE_FAIL_LINK(a)  CR ( \
                                                       a, \
                                                       FORM_BROWSER_FORMSET, \
                                                       SaveFailLink, \
