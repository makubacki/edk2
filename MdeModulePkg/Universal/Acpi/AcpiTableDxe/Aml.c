...
AML_BYTE_ENCODING  mAmlByteEncoding[] = {
  ...
  /* MatchOp - 0x89 */            {
    AML_MATCH_OP, 0, 6,
    { AML_OBJECT, AML_UINT8, AML_OBJECT,
                                    AML_UINT8,
                                    AML_OBJECT,
                                    AML_OBJECT },
    0
  ...
  /* CreateWordFieldOp - 0x8B */  {
    ...
    { AML_OBJECT, AML_OBJECT, AML_NAME,
                                    AML_NONE,
                                    AML_NONE,
                                    AML_NONE },
    0
  ...
  )
{
  ...
  // Search the table
  //
  for (Index = 0; Index < sizeof (mAmlByteEncoding)/
       sizeof (mAmlByteEncoding[0]); Index++)
  {
