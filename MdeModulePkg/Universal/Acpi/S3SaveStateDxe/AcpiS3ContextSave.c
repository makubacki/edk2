  ...
  )
{
  ...
  IdtGate =
    AllocateMemoryBelow4G (EfiReservedMemoryType, sizeof (IA32_IDT_GATE_DESCRIPTOR) * 0x100 + sizeof (IA32_DESCRIPTOR));
  ...
  AcpiS3Context->BootScriptStackBase = (EFI_PHYSICAL_ADDRESS)(UINTN)AllocateMemoryBelow4G (
                                                                      EfiReservedMemoryType,
  ...
  //
  AcpiS3Context->S3DebugBufferAddress = (EFI_PHYSICAL_ADDRESS)(UINTN)AllocateMemoryBelow4G (
                                                                       EfiReservedMemoryType,
                                                                       EFI_PAGE_SIZE
                                                                       );
