/** @file
  This file contains the required header files for the Firmware Volume Block (FVB) Variable Storage
  Runtime DXE protocol.
...
#ifndef _FVB_VARIABLE_STORAGE_RUNTIMEDXE_H_
#define _FVB_VARIABLE_STORAGE_RUNTIMEDXE_H_
