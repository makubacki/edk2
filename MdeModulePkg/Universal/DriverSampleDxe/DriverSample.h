...
#define DYNAMIC_ONE_OF_VAR_OFFSET        \
          OFFSET_OF (DRIVER_SAMPLE_CONFIGURATION, DynamicOneof)
#define DYNAMIC_ORDERED_LIST_VAR_OFFSET  \
          OFFSET_OF (DRIVER_SAMPLE_CONFIGURATION, DynamicOrderedList)
