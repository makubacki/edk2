  ...
  )
{
  ...
  DEBUG ((
    ...
    (UINTN)((UINT8 *)PrivateData + sizeof (EFI_CAPSULE_PEIM_PRIVATE_DATA) + (CapsuleNumber - 1) * sizeof (UINT64)),
    (UINTN)NewBuffer,
    Size
    ));
  CopyMem (
    (VOID *)(UINTN)NewBuffer,
    (VOID *)(UINTN)((UINT8 *)PrivateData + sizeof (EFI_CAPSULE_PEIM_PRIVATE_DATA) + (CapsuleNumber - 1) *
                    sizeof (UINT64)),
    Size
    );
  //
