      ...
      if (EFI_ERROR (Status)) {
        ...
        if (*NameSpace == NULL) {
          *NameSpace = AllocateCopyPool (
                         AsciiStrSize (StringPackage->StringPkgHdr->Language),
  ...
  )
{
  ...
  ASSERT (
    (NameSpace != NULL) && (KeywordData != NULL) && (ProgressErr != NULL) && (KeywordStringId != NULL) &&
    (DataBaseRecord != NULL)
    );
  ...
  )
{
  ...
  ASSERT (
    (NameSpace != NULL) && (DevicePath != NULL) && (KeywordData != NULL) && (ValueStr != NULL) &&
    (KeywordResp != NULL)
    );
  ...
  )
{
  ...
  for (Link = mPrivate.DatabaseList.ForwardLink; Link != &mPrivate.DatabaseList; Link = Link->ForwardLink) {
    ...
    for (StringLink = PackageListNode->StringPkgHdr.ForwardLink;
         StringLink != &PackageListNode->StringPkgHdr;
         StringLink = StringLink->ForwardLink) {
