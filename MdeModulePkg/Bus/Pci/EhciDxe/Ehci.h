...
struct _USB2_HC_DEV {
  ...
  //
  VOID                        *PeriodFrame;     // the buffer pointed by this pointer is used to store pci bus address
                                                // of the QH descriptor.
  VOID                        *PeriodFrameHost; // the buffer pointed by this pointer is used to store host memory
