...
//
#define NVME_MAX_QUEUES  2                                  // Number of I/O queues supported by the driver, 1 for AQ, 1
                                                            // for CQ
#define NVME_ASQ_SIZE    1                                  // Number of admin submission queue entries, which is
                                                            // 0-based
#define NVME_ACQ_SIZE    1                                  // Number of admin completion queue entries, which is
                                                            // 0-based
