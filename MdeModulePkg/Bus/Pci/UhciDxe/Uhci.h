...
struct _USB_HC_DEV {
  ...
  //
  UINT32                      *FrameBase;         // the buffer pointed by this pointer is used to store pci bus address
                                                  // of the QH descriptor.
  UINT32                      *FrameBaseHostAddr; // the buffer pointed by this pointer is used to store host memory
                                                  // address of the QH descriptor.
