  ...
  while (1) {
    switch (State) {
      ...
      case PS2_PROCESS_PACKET:
        ...
        //
        // X sign bit + 8 bit X Movement : 9-bit signed twos complement integer that presents the relative displacement
        // of the device in the X direction since the last data transmission.
