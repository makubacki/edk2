...
USB_KEYBOARD_LAYOUT_PACK_BIN  mUsbKeyboardLayoutBin = {
  ...
  1,                                                                                                                               // LayoutCount
  sizeof (USB_KEYBOARD_LAYOUT_PACK_BIN) - sizeof (UINT32) -
  sizeof (EFI_HII_PACKAGE_HEADER) - sizeof (UINT16),                                                                               // LayoutLength
  ...
  USB_KEYBOARD_KEY_COUNT,                                                                                                          // DescriptorCount
  {
    ...
    { EfiKeyB5,         'b',              'B',              0,                0,
      EFI_NULL_MODIFIER,                 EFI_AFFECTED_BY_STANDARD_SHIFT |
      EFI_AFFECTED_BY_CAPS_LOCK                                    },
    { EfiKeyB3,         'c',              'C',              0,                0,
      EFI_NULL_MODIFIER,                    EFI_AFFECTED_BY_STANDARD_SHIFT |
      EFI_AFFECTED_BY_CAPS_LOCK                                                     },
    ...
    { EfiKeyE10,        '0',              ')',              0,                0,
      EFI_NULL_MODIFIER,
      EFI_AFFECTED_BY_STANDARD_SHIFT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         },
    { EfiKeyEnter,      0x0d,             0x0d,             0,                0,
      EFI_NULL_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     },
    { EfiKeyEsc,        0x1b,             0x1b,             0,                0,
      EFI_NULL_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    },
    { EfiKeyBackSpace,  0x08,             0x08,             0,                0,
      EFI_NULL_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   },
    { EfiKeyTab,        0x09,             0x09,             0,                0,
      EFI_NULL_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  },
    { EfiKeySpaceBar,   ' ',              ' ',              0,                0,
      EFI_NULL_MODIFIER,
    ...
    { EfiKeyF12,        0x00,             0x00,             0,                0,
      ...
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        },
    { EfiKeyPrint,      0x00,             0x00,             0,                0,
      EFI_PRINT_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 },
    { EfiKeySLck,       0x00,             0x00,             0,                0,
      EFI_SCROLL_LOCK_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          },
    { EfiKeyPause,      0x00,             0x00,             0,                0,
      EFI_PAUSE_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   },
    { EfiKeyIns,        0x00,             0x00,             0,                0,
      EFI_INSERT_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            },
    { EfiKeyHome,       0x00,             0x00,             0,                0,
      EFI_HOME_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     },
    { EfiKeyPgUp,       0x00,             0x00,             0,                0,
      EFI_PAGE_UP_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              },
    { EfiKeyDel,        0x00,             0x00,             0,                0,
      EFI_DELETE_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       },
    { EfiKeyEnd,        0x00,             0x00,             0,                0,
      EFI_END_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                },
    { EfiKeyPgDn,       0x00,             0x00,             0,                0,
      EFI_PAGE_DOWN_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         },
    { EfiKeyRightArrow, 0x00,             0x00,             0,                0,
      EFI_RIGHT_ARROW_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  },
    { EfiKeyLeftArrow,  0x00,             0x00,             0,                0,
      EFI_LEFT_ARROW_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           },
    { EfiKeyDownArrow,  0x00,             0x00,             0,                0,
      EFI_DOWN_ARROW_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    },
    { EfiKeyUpArrow,    0x00,             0x00,             0,                0,
      EFI_UP_ARROW_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             },
    { EfiKeyNLck,       0x00,             0x00,             0,                0,
    ...
    { EfiKeyPeriod,     '.',              '.',              0,                0,
      ...
      EFI_AFFECTED_BY_STANDARD_SHIFT |
      EFI_AFFECTED_BY_NUM_LOCK                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    },
    { EfiKeyA4,         0x00,             0x00,             0,                0,
      EFI_MENU_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    },
    { EfiKeyLCtrl,      0,                0,                0,                0,
      EFI_LEFT_CONTROL_MODIFIER,
      0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        },
    { EfiKeyLShift,     0,                0,                0,                0,
  ...
  )
{
  ...
  //
  Status = HiiDatabase->SetKeyboardLayout (HiiDatabase,
  ...
  )
{
  ...
  //
  if ((!USBKBD_VALID_KEYCODE (KeyCode)) || ((KeyCode > 0x65) && (KeyCode <
                                                                 0xe0)) ||
      (KeyCode > 0xe7)) {
    return NULL;
  }
  ...
  )
{
  ...
  UsbKeyboardDevice->KeyConvertionTable = AllocateZeroPool (
                                            (NUMBER_OF_VALID_USB_KEYCODE)*sizeof (
                                                                                                 EFI_KEY_DESCRIPTOR));
  ...
  //
  KeyDescriptor = (EFI_KEY_DESCRIPTOR *)(((UINT8 *)KeyboardLayout) +
  ...
  for (Index = 0; Index < KeyboardLayout->DescriptorCount; Index++) {
    ...
    if (TempKey.Modifier == EFI_NS_KEY_MODIFIER) {
      ...
      for (Index2 = (UINT8)Index + 1; Index2 < KeyboardLayout->DescriptorCount;
           Index2++) {
  ...
  while (!IsQueueEmpty (&UsbKeyboardDevice->UsbKeyQueue)) {
    ...
    switch (KeyDescriptor->Modifier) {
      ...
      case EFI_NUM_LOCK_MODIFIER:
        ...
        // Toggle NumLock
        //
        UsbKeyboardDevice->NumLockOn =
          (BOOLEAN)(!(UsbKeyboardDevice->NumLockOn));
        SetKeyLED (UsbKeyboardDevice);
        break;
  ...
  )
{
  ...
  if (KeyDescriptor->Modifier == EFI_NS_KEY_MODIFIER) {
    ...
    //
    UsbKeyboardDevice->CurrentNsKey = FindUsbNsKey (UsbKeyboardDevice,
                                        KeyDescriptor);
    return EFI_NOT_READY;
  }
  ...
  if (UsbKeyboardDevice->CurrentNsKey != NULL) {
    ...
    // physical key.
    //
    KeyDescriptor = FindPhysicalKey (
                      UsbKeyboardDevice->CurrentNsKey, KeyDescriptor);
    UsbKeyboardDevice->CurrentNsKey = NULL;
  }
  ...
  //
  if (KeyDescriptor->Modifier >=
      (sizeof (ModifierValueToEfiScanCodeConvertionTable) / sizeof (UINT8))) {
    return EFI_DEVICE_ERROR;
  }

  KeyData->Key.ScanCode =
    ModifierValueToEfiScanCodeConvertionTable[KeyDescriptor->Modifier];
  ...
  //
  if ((KeyData->Key.UnicodeChar == 0x1B) && (KeyData->Key.ScanCode ==
                                             SCAN_NULL)) {
  ...
  for (Link = GetFirstNode (NotifyList); !IsNull (NotifyList, Link); Link =
    ...
    if (IsKeyRegistered (&CurrentNotify->KeyData, KeyData)) {
      ...
      //
      Enqueue (&UsbKeyboardDevice->EfiKeyQueueForNotify, KeyData,
        sizeof (*KeyData));
  ...
  )
{
  ...
  Queue->Buffer[0] = AllocatePool (sizeof (Queue->Buffer) /
                       sizeof (Queue->Buffer[0]) * ItemSize);
  ASSERT (Queue->Buffer[0] != NULL);

  for (Index = 1; Index < sizeof (Queue->Buffer) / sizeof (Queue->Buffer[0]);
       Index++) {
