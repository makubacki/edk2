  ...
  )
{
  ...
  while ((Link != &BlockArray->Entry) && (Link->ForwardLink != &BlockArray->Entry)) {
    ...
    if ((NewBlockData->Offset >= BlockData->Offset) &&
        (NewBlockData->Offset <= (BlockData->Offset + BlockData->Width))) {
  ...
  )
{
  ...
  ASSERT (
    (QuestionFlags &
     (~(EFI_IFR_FLAG_READ_ONLY | EFI_IFR_FLAG_CALLBACK | EFI_IFR_FLAG_RESET_REQUIRED | EFI_IFR_FLAG_REST_STYLE))) == 0
    );
  ...
  )
{
  ...
  ASSERT (
    (QuestionFlags &
     (~(EFI_IFR_FLAG_READ_ONLY | EFI_IFR_FLAG_CALLBACK | EFI_IFR_FLAG_RESET_REQUIRED | EFI_IFR_FLAG_REST_STYLE |
  ...
  )
{
  ...
  ASSERT (
    (DateFlags &
     (~(EFI_QF_DATE_YEAR_SUPPRESS | EFI_QF_DATE_MONTH_SUPPRESS | EFI_QF_DATE_DAY_SUPPRESS | EFI_QF_DATE_STORAGE))) == 0
    );
  ...
  )
{
  ...
  ASSERT (
    (TimeFlags & (~(QF_TIME_HOUR_SUPPRESS | QF_TIME_MINUTE_SUPPRESS | QF_TIME_SECOND_SUPPRESS | QF_TIME_STORAGE))) ==
    0
    );
