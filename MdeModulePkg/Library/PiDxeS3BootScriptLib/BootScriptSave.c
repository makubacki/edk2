  ...
  )
{
  ...
  CopyMem (
    mS3BootScriptTablePtr->TableBase + mS3BootScriptTablePtr->TableLength,
    &ScriptTerminate,
  ...
  )
{
  ...
  if (S3TableBase == 0) {
    ...
    mS3BootScriptTablePtr->TableMemoryPageNumber =
      (UINT16)(2 + PcdGet16 (PcdS3BootScriptRuntimeTableReservePageNumber));
  }

  // Here we do not count the reserved memory for runtime script table.
  PageNumber =
    (UINT16)(mS3BootScriptTablePtr->TableMemoryPageNumber - PcdGet16 (PcdS3BootScriptRuntimeTableReservePageNumber));
  ...
  if (EFI_PAGES_TO_SIZE ((UINTN)PageNumber) < (TableLength + EntryLength + sizeof (EFI_BOOT_SCRIPT_TERMINATE))) {
    ...
    mS3BootScriptTablePtr->TableMemoryPageNumber =
      (UINT16)(2 + PageNumber + PcdGet16 (PcdS3BootScriptRuntimeTableReservePageNumber));
  }
  ...
  )
{
  ...
  //
  if ((mS3BootScriptTablePtr->TableLength + EntryLength + sizeof (EFI_BOOT_SCRIPT_TERMINATE)) <=
  ...
  )
{
  ...
  mS3BootScriptTablePtr->TableLength =
    (UINT32)(mS3BootScriptTablePtr->BootTimeScriptLength - sizeof (EFI_BOOT_SCRIPT_TERMINATE));
}
