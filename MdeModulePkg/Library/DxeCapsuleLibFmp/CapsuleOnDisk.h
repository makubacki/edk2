...
typedef struct {
  ...
  CHAR16           *FileNameFirstPart;   /// Text to the left of right-most period in the file name. String is
                                         /// capitialized
  CHAR16           *FileNameSecondPart;  /// Text to the right of right-most period in the file name.String is
                                         /// capitialized. Maybe NULL
} FILE_INFO_ENTRY;
