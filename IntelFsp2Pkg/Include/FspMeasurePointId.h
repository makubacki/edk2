...
#define  FSP_PERF_ID_SYSTEM_AGENT_INIT_EXIT   \
                                                (FSP_PERF_ID_SYSTEM_AGENT_INIT_ENTRY +  1)
...
#define  FSP_PERF_ID_API_TEMP_RAM_INIT_EXIT   \
                                                (FSP_PERF_ID_API_TEMP_RAM_INIT_ENTRY + 1)

#define  FSP_PERF_ID_API_FSP_MEMORY_INIT_ENTRY  0xF2
#define  FSP_PERF_ID_API_FSP_MEMORY_INIT_EXIT   \
                                                  (FSP_PERF_ID_API_FSP_MEMORY_INIT_ENTRY + 1)

#define  FSP_PERF_ID_API_TEMP_RAM_EXIT_ENTRY  0xF4
#define  FSP_PERF_ID_API_TEMP_RAM_EXIT_EXIT   \
                                                (FSP_PERF_ID_API_TEMP_RAM_EXIT_ENTRY + 1)

#define  FSP_PERF_ID_API_FSP_SILICON_INIT_ENTRY  0xF6
#define  FSP_PERF_ID_API_FSP_SILICON_INIT_EXIT   \
                                                   (FSP_PERF_ID_API_FSP_SILICON_INIT_ENTRY + 1)

#define  FSP_PERF_ID_API_NOTIFY_POST_PCI_ENTRY  0xF8
#define  FSP_PERF_ID_API_NOTIFY_POST_PCI_EXIT   \
                                                  (FSP_PERF_ID_API_NOTIFY_POST_PCI_ENTRY + 1)

#define  FSP_PERF_ID_API_NOTIFY_READY_TO_BOOT_ENTRY  0xFA
#define  FSP_PERF_ID_API_NOTIFY_READY_TO_BOOT_EXIT   \
                                                       (FSP_PERF_ID_API_NOTIFY_READY_TO_BOOT_ENTRY + 1)

#define  FSP_PERF_ID_API_NOTIFY_END_OF_FIRMWARE_ENTRY  0xFC
#define  FSP_PERF_ID_API_NOTIFY_END_OF_FIRMWARE_EXIT   \
                                                         (FSP_PERF_ID_API_NOTIFY_END_OF_FIRMWARE_ENTRY + 1)
