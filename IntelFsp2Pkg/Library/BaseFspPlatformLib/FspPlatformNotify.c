  ...
  )
{
  ...
  PERF_START_EX (
               ...
               FSP_STATUS_CODE_TEMP_RAM_INIT | FSP_STATUS_CODE_COMMON_CODE| FSP_STATUS_CODE_API_ENTRY
               );
  PERF_END_EX (
             &gFspPerformanceDataGuid,
             "EventRec",
             NULL,
             (FspData->PerfData[1] & FSP_PERFORMANCE_DATA_TIMER_MASK),
  ...
  PERF_START_EX (
               ...
               FSP_STATUS_CODE_MEMORY_INIT | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_ENTRY
               );
  PERF_END_EX (
             &gFspPerformanceDataGuid,
             "EventRec",
             NULL,
             0,
             FSP_STATUS_CODE_MEMORY_INIT | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_EXIT
             );
  REPORT_STATUS_CODE (
                     EFI_PROGRESS_CODE,
                     FSP_STATUS_CODE_MEMORY_INIT | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_EXIT
  ...
  if (GetFspApiCallingIndex () == TempRamExitApiIndex) {
    ...
    PERF_START_EX (
                 ...
                 NULL,
                 0,
                 FSP_STATUS_CODE_TEMP_RAM_EXIT | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_ENTRY
                 );
    REPORT_STATUS_CODE (
                       EFI_PROGRESS_CODE,
                       FSP_STATUS_CODE_TEMP_RAM_EXIT | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_ENTRY
  ...
  )
{
  ...
  PERF_END_EX (
             ...
             NULL,
             0,
             FSP_STATUS_CODE_TEMP_RAM_EXIT | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_EXIT
             );
  REPORT_STATUS_CODE (
                     EFI_PROGRESS_CODE,
                     FSP_STATUS_CODE_TEMP_RAM_EXIT | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_EXIT
  ...
  while (NotificationCount < sizeof (mFspNotifySequence) / sizeof (UINT32)) {
    ...
    if (NotificationCount == 0) {
      ...
      PERF_START_EX (
                    ...
                    NULL,
                    0,
                    FSP_STATUS_CODE_POST_PCIE_ENUM_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_ENTRY
                    );
      REPORT_STATUS_CODE (
                         EFI_PROGRESS_CODE,
                         FSP_STATUS_CODE_POST_PCIE_ENUM_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_ENTRY
      ...
      PERF_START_EX (
                   ...
                   NULL,
                   0,
                   FSP_STATUS_CODE_READY_TO_BOOT_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_ENTRY
                   );
      REPORT_STATUS_CODE (
                         EFI_PROGRESS_CODE,
                         FSP_STATUS_CODE_READY_TO_BOOT_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_ENTRY
      ...
      PERF_START_EX (
                    ...
                    NULL,
                    0,
                    FSP_STATUS_CODE_END_OF_FIRMWARE_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_ENTRY
                    );
      REPORT_STATUS_CODE (
                         EFI_PROGRESS_CODE,
                         FSP_STATUS_CODE_END_OF_FIRMWARE_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_ENTRY
    ...
    if ((NotificationCount - 1) == 0) {
      PERF_END_EX (
                 ...
                 NULL,
                 0,
                 FSP_STATUS_CODE_POST_PCIE_ENUM_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_EXIT
                 );
      REPORT_STATUS_CODE (
                         EFI_PROGRESS_CODE,
                         FSP_STATUS_CODE_POST_PCIE_ENUM_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_EXIT
      ...
      PERF_END_EX (
                 ...
                 NULL,
                 0,
                 FSP_STATUS_CODE_READY_TO_BOOT_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_EXIT
                 );
      REPORT_STATUS_CODE (
                         EFI_PROGRESS_CODE,
                         FSP_STATUS_CODE_READY_TO_BOOT_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_EXIT
      ...
      PERF_END_EX (
                 ...
                 NULL,
                 0,
                 FSP_STATUS_CODE_END_OF_FIRMWARE_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_EXIT
                 );
      REPORT_STATUS_CODE (
                         EFI_PROGRESS_CODE,
                         FSP_STATUS_CODE_END_OF_FIRMWARE_NOTIFICATION | FSP_STATUS_CODE_COMMON_CODE | FSP_STATUS_CODE_API_EXIT
    ...
    if (GetFspGlobalDataPointer ()->FspMode == FSP_IN_API_MODE) {
      ...
      do {
        ...
        if (Status != EFI_SUCCESS) {
          DEBUG (
                (DEBUG_ERROR, "!!!ERROR: NotifyPhaseApi() [Phase: %08X] - Failed - [Status: 0x%08X]\n",
