...
//
// Definition for starting symbol of a normal debug packet. Choose a non-ASCII to avoid conflict with other serial
// output.
//
#define DEBUG_STARTING_SYMBOL_NORMAL  (0xFE)

//
// Definition for starting symbol of a (C)ompressed debug packet. Choose a non-ASCII to avoid conflict with other serial
// output.
//
...
//
#define DEBUG_DATA_UPPER_LIMIT  0xff                    // Upper limit for the data size, by the limit of the packet
                                                        // header definition.
