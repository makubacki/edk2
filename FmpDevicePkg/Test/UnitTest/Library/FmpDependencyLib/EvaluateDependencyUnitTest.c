...
//
#define IMAGE_TYPE_ID_1  \
  { 0x97144DFA, 0xEB8E, 0xD14D, {0x8B, 0x4D, 0x39, 0x88, 0x24, 0x96, 0x56, 0x42}}

//
// Image Type ID of FMP device B
//
#define IMAGE_TYPE_ID_2  \
  { 0xA42A7370, 0x433A, 0x684D, {0x9A, 0xA1, 0xDE, 0x62, 0x23, 0x30, 0x6C, 0xF3}}
...
static UINT8  mExpression6[] = {
  EFI_FMP_DEP_VERSION_STR, 'T', 'e', 's', 't', EFI_FMP_DEP_TRUE, EFI_FMP_DEP_END
};
...
static UINT8  mExpression9[] = {
  EFI_FMP_DEP_TRUE, EFI_FMP_DEP_FALSE, EFI_FMP_DEP_GTE, EFI_FMP_DEP_END
};
...
static BASIC_TEST_CONTEXT  mBasicTestTrue1 = {
  mExpression1, sizeof (mExpression1), TRUE
};
static BASIC_TEST_CONTEXT  mBasicTestTrue2 = {
  mExpression2, sizeof (mExpression2), TRUE
};
static BASIC_TEST_CONTEXT  mBasicTestFalse1 = {
  mExpression3, sizeof (mExpression3), FALSE
};
static BASIC_TEST_CONTEXT  mBasicTestFalse2 = {
  mExpression4, sizeof (mExpression4), FALSE
};
static BASIC_TEST_CONTEXT  mBasicTestInvalid1 = {
  mExpression1, sizeof (mExpression1) - 1, FALSE
};
static BASIC_TEST_CONTEXT  mBasicTestInvalid2 = {
  mExpression5, sizeof (mExpression5), FALSE
};
static BASIC_TEST_CONTEXT  mBasicTestInvalid3 = {
  mExpression6, sizeof (mExpression6), FALSE
};
static BASIC_TEST_CONTEXT  mBasicTestInvalid4 = {
  mExpression7, sizeof (mExpression7), FALSE
};
static BASIC_TEST_CONTEXT  mBasicTestInvalid5 = {
  mExpression8, sizeof (mExpression8), FALSE
};
static BASIC_TEST_CONTEXT  mBasicTestInvalid6 = {
  mExpression9, sizeof (mExpression9), FALSE
};
static BASIC_TEST_CONTEXT  mBasicTestInvalid7 = {
  mExpression10, sizeof (mExpression10), FALSE
};
static BASIC_TEST_CONTEXT  mBasicTestInvalid8 = {
  mExpression11, sizeof (mExpression11), FALSE
};
