  ...
  )
{
  ...
  switch (BitsPerPixel) {
    ...
    default:
      ...
      DEBUG (
         (DEBUG_ERROR, "ArmVeGraphics_Blt: EfiBltVideoToVideo: INVALID Number of Bits Per Pixel: %d\n",
          BitsPerPixel)
         );
  ...
  switch (BitsPerPixel) {
    case LcdBitsPerPixel_24:
      ...
      for (DestinationLine = DestinationY;
        ...
        DestinationAddr =
          (VOID *) ((UINT32 *) FrameBufferBase + DestinationLine * HorizontalResolution  + DestinationX);
    ...
    case LcdBitsPerPixel_16_555:
      ...
      for (DestinationLine = DestinationY;
        ...
        for (DestinationPixelX = DestinationX;
             ...
             DestinationPixelX++) {
          // Calculate the target address:
          DestinationPixel16bit =  (UINT16 *) FrameBufferBase + DestinationLine * HorizontalResolution +
                                  DestinationPixelX;
  ...
  switch (BitsPerPixel) {
    case LcdBitsPerPixel_24:
      ...
      for (SourceLine = SourceY, DestinationLine = DestinationY;
        ...
        SourceAddr = (VOID *) ((UINT32 *) FrameBufferBase + SourceLine      * HorizontalResolution          + SourceX);
        DestinationAddr =
          (VOID *) ((UINT32 *) BltBuffer       + DestinationLine * BltBufferHorizontalResolution + DestinationX);
    ...
    default:
      // Can't handle this case
      DEBUG (
         (DEBUG_ERROR, "LcdGraphicsBlt: EfiBltVideoToBltBuffer: INVALID Number of Bits Per Pixel: %d\n",
          BitsPerPixel)
         );
      Status = EFI_INVALID_PARAMETER;
      break;
  ...
  )
{
  ...
  switch (BitsPerPixel) {
    ...
    default:
      // Can't handle this case
      DEBUG (
         (DEBUG_ERROR, "LcdGraphicsBlt: EfiBltBufferToVideo: INVALID Number of Bits Per Pixel: %d\n",
          BitsPerPixel)
         );
      Status = EFI_INVALID_PARAMETER;
      break;
  ...
  )
{
  ...
  DEBUG (
         (DEBUG_INFO, "LcdGraphicsBlt (BltOperation:%d,DestX:%d,DestY:%d,Width:%d,Height:%d) res(%d,%d)\n",
  ...
  if ((BltOperation == EfiBltVideoFill) || (BltOperation == EfiBltBufferToVideo) ||
  ...
  if ((BltOperation == EfiBltVideoToBltBuffer) || (BltOperation == EfiBltVideoToVideo)) {
    if ((SourceY + Height > VerticalResolution) || (SourceX + Width > HorizontalResolution)) {
      ...
      DEBUG (
           (DEBUG_INFO, "                      - SourceY=%d + Height=%d > VerticalResolution=%d.\n", SourceY, Height,
            VerticalResolution)
           );
      DEBUG (
           (DEBUG_INFO, "                      - SourceX=%d + Width=%d > HorizontalResolution=%d.\n", SourceX, Width,
            HorizontalResolution)
           );
      Status = EFI_INVALID_PARAMETER;
      goto EXIT;
  ...
  if ((BltOperation == EfiBltVideoFill) || (BltOperation == EfiBltBufferToVideo) ||
    ...
    if ((DestinationY + Height > VerticalResolution) || (DestinationX + Width > HorizontalResolution)) {
      ...
      DEBUG (
           (DEBUG_INFO, "                      - DestinationY=%d + Height=%d > VerticalResolution=%d.\n",
            DestinationY, Height, VerticalResolution)
           );
      DEBUG (
           (DEBUG_INFO, "                      - DestinationX=%d + Width=%d > HorizontalResolution=%d.\n",
  ...
  switch (BltOperation) {
    ...
    case EfiBltVideoToBltBuffer:
      Status =
        BltVideoToBltBuffer (This, BltBuffer, SourceX, SourceY, DestinationX, DestinationY, Width, Height, Delta);
      break;
