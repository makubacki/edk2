  ...
  )
{
  ...
  AddTestCase (
    ManualTestCase,
    "Check the case to map [0, 1G] to [8K, 1G+8K]",
    "Manual Test Case3",
    TestCase1Gmapto4K,
    NULL,
    NULL,
  ...
  AddTestCase (
    RandomTestCase,
    "Random Test for Paging4Level1G",
    "Random Test Case2",
    TestCaseforRandomTest,
    NULL,
    NULL,
  ...
  AddTestCase (
    RandomTestCase,
    "Random Test for Paging5Level1G",
    "Random Test Case4",
    TestCaseforRandomTest,
    NULL,
    NULL,
