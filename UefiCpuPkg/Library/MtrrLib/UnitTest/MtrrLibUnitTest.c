  ...
  )
{
  ...
  AddTestCase (
    MtrrApiTests,
    "Test MtrrGetMemoryAttributeInVariableMtrr",
    "MtrrGetMemoryAttributeInVariableMtrr",
    UnitTestMtrrGetMemoryAttributeInVariableMtrr,
    NULL,
    NULL,
       ...
       SystemIndex++)
  {
    for (Index = 0; Index < Iteration; Index++) {
      ...
      AddTestCase (
        MtrrApiTests,
        "Test MtrrSetMemoryAttributeInMtrrSettings",
      ...
      AddTestCase (
        MtrrApiTests,
        "Test MtrrSetMemoryAttributesInMtrrSettings",
