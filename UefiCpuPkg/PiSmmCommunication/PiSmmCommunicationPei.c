  ...
  )
{
  ...
  DEBUG (
        (EFI_D_INFO, "PiSmmCommunicationPei BufferPtrAddress - 0x%016lx, BufferPtr: 0x%016lx\n",
         SmmCommunicationContext->BufferPtrAddress,
         *(EFI_PHYSICAL_ADDRESS *) (UINTN) SmmCommunicationContext->BufferPtrAddress)
        );
