...
SMBIOS_TABLE_TYPE8  gSmbiosType8Template1 = {
  ...
  PortConnectorTypeNone,        // InternalConnectorType;          ///< The enumeration value from
                                // MISC_PORT_CONNECTOR_TYPE.
  1,                            // ExternalReferenceDesignator String
  PortConnectorTypeNone,        // ExternalConnectorType;          ///< The enumeration value from
                                // MISC_PORT_CONNECTOR_TYPE.
...
SMBIOS_TABLE_TYPE8  gSmbiosType8Template3 = {
  ...
  PortConnectorTypeNone,        // InternalConnectorType;          ///< The enumeration value from
                                // MISC_PORT_CONNECTOR_TYPE.
  1,                            // ExternalReferenceDesignator String
  PortConnectorTypeRJ45,        // ExternalConnectorType;          ///< The enumeration value from
                                // MISC_PORT_CONNECTOR_TYPE.
...
SMBIOS_TABLE_TYPE8  gSmbiosType8Template4 = {
  ...
  PortConnectorTypeNone,        // InternalConnectorType;          ///< The enumeration value from
                                // MISC_PORT_CONNECTOR_TYPE.
  1,                            // ExternalReferenceDesignator String
  PortConnectorTypeUsb,         // ExternalConnectorType;          ///< The enumeration value from
                                // MISC_PORT_CONNECTOR_TYPE.
...
SMBIOS_TABLE_TYPE8  gSmbiosType8Template8 = {
  ...
  PortConnectorTypeNone,              // InternalConnectorType;          ///< The enumeration value from
                                      // MISC_PORT_CONNECTOR_TYPE.
  1,                                  // ExternalReferenceDesignator String
  PortConnectorTypeHeadPhoneMiniJack, // ExternalConnectorType;          ///< The enumeration value from
                                      // MISC_PORT_CONNECTOR_TYPE.
...
SMBIOS_TABLE_TYPE16  gSmbiosType16Template = {
  ...
  MemoryArrayLocationSystemBoard, // Location;                       ///< The enumeration value from
                                  // MEMORY_ARRAY_LOCATION.
  MemoryArrayUseSystemMemory,     // Use;                            ///< The enumeration value from MEMORY_ARRAY_USE.
  MemoryErrorCorrectionUnknown,   // MemoryErrorCorrection;          ///< The enumeration value from
