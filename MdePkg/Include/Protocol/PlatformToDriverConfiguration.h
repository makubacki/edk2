...
**/
typedef struct {
  CHAR8     *CLPCommand;           ///< A pointer to the null-terminated UTF-8 string that specifies the DMTF SM CLP
                                   ///< command
                                   ///< line that the driver is required to parse and process when this function is
                                   ///< called.
  ...
  CHAR8     *CLPReturnString;      ///< A pointer to the null-terminated UTF-8 string that indicates the CLP return
                                   ///< status
                                   ...
                                   ///< EFI_PLATFORM_TO_DRIVER_CONFIGURATION_PROTOC OL and undefined prior to the call
                                   ///< to
                                   ///< Response().
  ...
  UINT8     CLPErrorValue;         ///< SM CLP Processing Error Value (see DMTF SM CLP Specification 1.0 Final Standard
                                   ///< - Table 6).
                                   ///< This field is filled in by the consumer of the
                                   ///< EFI_PLATFORM_TO_DRIVER_CONFIGURATION_PROTOCOL and undefined prior to the call to
                                   ///< Response().
  UINT16    CLPMsgCode;            ///< Bit 15: OEM Message Code Flag 0 = Message Code is an SM CLP Probable
                                   ...
                                   ///< the EFI_PLATFORM_TO_DRIVER_CONFIGURATION_PROTOC OL and undefined prior to the
                                   ///< call to
                                   ///< Response().
