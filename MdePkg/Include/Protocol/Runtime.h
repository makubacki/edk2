...
struct _EFI_RUNTIME_ARCH_PROTOCOL {
  ...
  UINT32                   MemoryDesciptorVersion; ///< Version of a memory descriptor that is returned by
                                                   ///< GetMemoryMap().
  UINTN                    MemoryMapSize;///< Size of the memory map in bytes contained in MemoryMapPhysical and
                                         ///< MemoryMapVirtual.
  ...
  EFI_MEMORY_DESCRIPTOR    *MemoryMapVirtual;  ///< Pointer to MemoryMapPhysical that is updated to virtual mode after
