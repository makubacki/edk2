...
//
#define ATA_CMD_DIPM_SUB  0x03                                 // defined in ACS-3 : Count value in SetFeature
                                                               // identification : 03h  Device-initiated interface power
                                                               // state transitions
...
//
#define ATA_CMD_DEVSLEEP_SUB  0x09                             // defined in SATA 3.2 Gold Spec :  Count value in
                                                               // SetFeature identification : 09h  Device Sleep
...
// Error Register
//
#define ATA_ERRREG_BBK    BIT7                                ///< Bad block detected      defined from ATA-1, obsoleted
                                                              ///< from ATA-2
#define ATA_ERRREG_UNC    BIT6                                ///< Uncorrectable Data      defined from ATA-1, obsoleted
                                                              ///< from ATA-4
#define ATA_ERRREG_MC     BIT5                                ///< Media Change            defined from ATA-1, obsoleted
                                                              ///< from ATA-4
#define ATA_ERRREG_IDNF   BIT4                                ///< ID Not Found            defined from ATA-1, obsoleted
                                                              ///< from ATA-4
#define ATA_ERRREG_MCR    BIT3                                ///< Media Change Requested  defined from ATA-1, obsoleted
                                                              ///< from ATA-4
#define ATA_ERRREG_ABRT   BIT2                                ///< Aborted Command         defined from ATA-1
#define ATA_ERRREG_TK0NF  BIT1                                ///< Track 0 Not Found       defined from ATA-1, obsoleted
                                                              ///< from ATA-4
#define ATA_ERRREG_AMNF   BIT0                                ///< Address Mark Not Found  defined from ATA-1, obsoleted
                                                              ///< from ATA-4
...
#define ATA_STSREG_DWF   BIT5                                 ///< Drive Write Fault       defined from ATA-1, obsoleted
                                                              ///< from ATA-4
#define ATA_STSREG_DF    BIT5                                 ///< Drive Fault             defined from ATA-6
#define ATA_STSREG_DSC   BIT4                                 ///< Disk Seek Complete      defined from ATA-1, obsoleted
                                                              ///< from ATA-4
#define ATA_STSREG_DRQ   BIT3                                 ///< Data Request            defined from ATA-1
#define ATA_STSREG_CORR  BIT2                                 ///< Corrected Data          defined from ATA-1, obsoleted
                                                              ///< from ATA-4
#define ATA_STSREG_IDX   BIT1                                 ///< Index                   defined from ATA-1, obsoleted
                                                              ///< from ATA-4
