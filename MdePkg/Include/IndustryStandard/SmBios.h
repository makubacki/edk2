...
/// string-set. For example, if a string field contains 02h, it references the second string following the formatted
/// portion
/// of the SMBIOS structure. If a string field references no string, a null (0) is placed in that string field. If the
/// formatted portion of the structure contains string-reference fields and all the string fields are set to 0 (no
/// string
...
typedef struct {
  SMBIOS_STRUCTURE                   Hdr;
  UINT8                              ErrDetectMethod;         ///< The enumeration value from
                                                              ///< MEMORY_ERROR_DETECT_METHOD.
  MEMORY_ERROR_CORRECT_CAPABILITY    ErrCorrectCapability;
  UINT8                              SupportInterleave;       ///< The enumeration value from
                                                              ///< MEMORY_SUPPORT_INTERLEAVE_TYPE.
  UINT8                              CurrentInterleave;       ///< The enumeration value from
                                                              ///< MEMORY_SUPPORT_INTERLEAVE_TYPE .
...
typedef enum {
  ...
  SlotTypePciExpressMini52pinWithBSKO    = 0x21,    ///< PCI Express Mini 52-pin (CEM spec. 2.0) with bottom-side
                                                    ///< keep-outs.
  SlotTypePciExpressMini52pinWithoutBSKO = 0x22,    ///< PCI Express Mini 52-pin (CEM spec. 2.0) without bottom-side
                                                    ///< keep-outs.
  SlotTypePciExpressMini76pin            = 0x23,    ///< PCI Express Mini 76-pin (CEM spec. 2.0) Corresponds to
                                                    ///< Display-Mini card.
...
///
typedef struct {
  UINT8                  DeviceType;                ///< Bit [6:0] - enumeration type of device from
                                                    ///< MISC_ONBOARD_DEVICE_TYPE.
...
typedef struct {
  SMBIOS_STRUCTURE    Hdr;
  UINT8               Type;                                 ///< The enumeration value from
                                                            ///< BUILTIN_POINTING_DEVICE_TYPE.
  UINT8               Interface;                            ///< The enumeration value from
                                                            ///< BUILTIN_POINTING_DEVICE_INTERFACE.
...
typedef struct {
  ...
  UINT8                  DeviceChemistry;                         ///< The enumeration value from
                                                                  ///< PORTABLE_BATTERY_DEVICE_CHEMISTRY.
...
typedef struct {
  SMBIOS_STRUCTURE    Hdr;
  UINT8               Reserved[6];
  UINT8               BootStatus;                         ///< The enumeration value from
                                                          ///< MISC_BOOT_INFORMATION_STATUS_DATA_TYPE.
} SMBIOS_TABLE_TYPE32;
...
typedef struct {
  ...
  UINT8                  Type;                                    ///< The enumeration value from
                                                                  ///< MISC_MANAGEMENT_DEVICE_TYPE.
  UINT32                 Address;
  UINT8                  AddressType;                             ///< The enumeration value from
                                                                  ///< MISC_MANAGEMENT_DEVICE_ADDRESS_TYPE.
} SMBIOS_TABLE_TYPE34;
...
typedef struct {
  ...
  UINT8                  DeviceType;                        ///< The enumeration value from
                                                            ///< ONBOARD_DEVICE_EXTENDED_INFO_TYPE
