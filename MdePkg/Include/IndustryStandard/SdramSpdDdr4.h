...
typedef struct {
  ...
  SPD4_MANUFACTURING_DATE            Date;                       ///< Module Manufacturing Year, in BCD (range:
                                                                 ///< 2000-2255)
...
typedef struct {
  SPD4_DEVICE_DESCRIPTION_STRUCT               Description;              ///< 0       Number of Serial PD Bytes Written
                                                                         ///< / SPD Device Size / CRC Coverage 1, 2
  ...
  SPD4_TRCD_MIN_MTB_STRUCT                     tRCDmin;                 ///< 25      Minimum RAS# to CAS# Delay Time
                                                                        ///< (tRCDmin)
  SPD4_TRP_MIN_MTB_STRUCT                      tRPmin;                  ///< 26      Minimum Row Precharge Delay Time
                                                                        ///< (tRPmin)
  SPD4_TRAS_TRC_MIN_MTB_STRUCT                 tRASMintRCMinUpper;      ///< 27      Upper Nibbles for tRAS and tRC
  SPD4_TRAS_MIN_MTB_STRUCT                     tRASmin;                 ///< 28      Minimum Active to Precharge Delay
                                                                        ///< Time (tRASmin), Least Significant Byte
  SPD4_TRC_MIN_MTB_STRUCT                      tRCmin;                  ///< 29      Minimum Active to Active/Refresh
                                                                        ///< Delay Time (tRCmin), Least Significant Byte
  SPD4_TRFC_MIN_MTB_STRUCT                     tRFC1min;                ///< 30-31   Minimum Refresh Recovery Delay Time
                                                                        ///< (tRFC1min)
  SPD4_TRFC_MIN_MTB_STRUCT                     tRFC2min;                ///< 32-33   Minimum Refresh Recovery Delay Time
                                                                        ///< (tRFC2min)
  ...
  SPD4_TFAW_MIN_MTB_STRUCT                     tFAWmin;                 ///< 37      Minimum Four Activate Window Delay
                                                                        ///< Time (tFAWmin)
  SPD4_TRRD_MIN_MTB_STRUCT                     tRRD_Smin;               ///< 38      Minimum Activate to Activate Delay
                                                                        ///< Time (tRRD_Smin), different bank group
  SPD4_TRRD_MIN_MTB_STRUCT                     tRRD_Lmin;               ///< 39      Minimum Activate to Activate Delay
  ...
  SPD4_TWR_MIN_MTB_STRUCT                      tWRmin;                  ///< 42      Minimum Write Recovery Time
                                                                        ///< (tWRmin)
  SPD4_TWTR_UPPER_NIBBLE_STRUCT                tWTRUpperNibble;         ///< 43      Upper Nibbles for tWTRmin
  SPD4_TWTR_MIN_MTB_STRUCT                     tWTR_Smin;               ///< 44      Minimum Write to Read Time
                                                                        ///< (tWTR_Smin), Different Bank Group
  SPD4_TWTR_MIN_MTB_STRUCT                     tWTR_Lmin;               ///< 45      Minimum Write to Read Time
  ...
  SPD4_TCCD_MIN_FTB_STRUCT                     tCCD_LminFine;           ///< 117     Fine Offset for Minimum CAS to CAS
                                                                        ///< Delay Time (tCCD_Lmin), same bank group
  SPD4_TRRD_MIN_FTB_STRUCT                     tRRD_LminFine;           ///< 118     Fine Offset for Minimum Activate to
                                                                        ///< Activate Delay Time (tRRD_Lmin), different
                                                                        ///< bank group
  SPD4_TRRD_MIN_FTB_STRUCT                     tRRD_SminFine;           ///< 119     Fine Offset for Minimum Activate to
                                                                        ///< Activate Delay Time (tRRD_Smin), same bank
                                                                        ///< group
  SPD4_TRC_MIN_FTB_STRUCT                      tRCminFine;              ///< 120     Fine Offset for Minimum Active to
                                                                        ///< Active/Refresh Delay Time (tRCmin)
  SPD4_TRP_MIN_FTB_STRUCT                      tRPminFine;              ///< 121     Fine Offset for Minimum Row
                                                                        ///< Precharge Delay Time (tRPabmin)
  SPD4_TRCD_MIN_FTB_STRUCT                     tRCDminFine;             ///< 122     Fine Offset for Minimum RAS# to
                                                                        ///< CAS# Delay Time (tRCDmin)
  SPD4_TAA_MIN_FTB_STRUCT                      tAAminFine;              ///< 123     Fine Offset for Minimum CAS Latency
                                                                        ///< Time (tAAmin)
  SPD4_TCK_MAX_FTB_STRUCT                      tCKmaxFine;              ///< 124     Fine Offset for SDRAM Minimum Cycle
                                                                        ///< Time (tCKmax)
  SPD4_TCK_MIN_FTB_STRUCT                      tCKminFine;              ///< 125     Fine Offset for SDRAM Maximum Cycle
                                                                        ///< Time (tCKmin)
...
typedef struct {
  ...
  SPD4_UNBUF_ADDRESS_MAPPING             AddressMappingEdgeConn;  ///< 131     Address Mapping from Edge Connector to
                                                                  ///< DRAM
...
typedef struct {
  SPD4_RDIMM_MODULE_NOMINAL_HEIGHT                       ModuleNominalHeight;              ///< 128     Module Nominal
                                                                                           ///< Height
  SPD4_RDIMM_MODULE_NOMINAL_THICKNESS                    ModuleMaximumThickness;           ///< 129     Module Maximum
                                                                                           ///< Thickness
  SPD4_RDIMM_REFERENCE_RAW_CARD                          ReferenceRawCardUsed;             ///< 130     Reference Raw
                                                                                           ///< Card Used
  SPD4_RDIMM_MODULE_ATTRIBUTES                           DimmModuleAttributes;             ///< 131     DIMM Module
                                                                                           ///< Attributes
  SPD4_RDIMM_THERMAL_HEAT_SPREADER_SOLUTION              DimmThermalHeatSpreaderSolution;  ///< 132     RDIMM Thermal
                                                                                           ///< Heat Spreader Solution
  SPD4_MANUFACTURER_ID_CODE                              RegisterManufacturerIdCode;       ///< 133-134 Register
                                                                                           ///< Manufacturer ID Code
  SPD4_RDIMM_REGISTER_REVISION_NUMBER                    RegisterRevisionNumber;           ///< 135     Register
                                                                                           ///< Revision Number
  ...
  SPD4_RDIMM_REGISTER_OUTPUT_DRIVE_STRENGTH_FOR_CONTROL_COMMAND_ADDRESS
                                                         RegisterOutputDriveStrengthForControlCommandAddress; ///< 137
                                                                                                              ...
                                                                                                              ///< Command
                                                                                                              ///< Address
  SPD4_RDIMM_REGISTER_OUTPUT_DRIVE_STRENGTH_FOR_CLOCK    RegisterOutputDriveStrengthForClock;                 ///< 138
                                                                                                              ///<   
                                                                                                              ///<  Register
                                                                                                              ///< Output
                                                                                                              ///< Drive
                                                                                                              ...
                                                                                                              ///< for
                                                                                                              ///< Clock
  UINT8                                                  Reserved[253 - 139 + 1];                             ///< 253-139
                                                                                                              ///< Reserved
...
typedef struct {
  SPD4_LRDIMM_MODULE_NOMINAL_HEIGHT                            ModuleNominalHeight;              ///< 128     Module
                                                                                                 ///< Nominal Height
  SPD4_LRDIMM_MODULE_NOMINAL_THICKNESS                         ModuleMaximumThickness;           ///< 129     Module
                                                                                                 ///< Maximum Thickness
  SPD4_LRDIMM_REFERENCE_RAW_CARD                               ReferenceRawCardUsed;             ///< 130     Reference
                                                                                                 ///< Raw Card Used
  SPD4_LRDIMM_MODULE_ATTRIBUTES                                DimmModuleAttributes;             ///< 131     DIMM
                                                                                                 ///< Module Attributes
  SPD4_LRDIMM_THERMAL_HEAT_SPREADER_SOLUTION                   ThermalHeatSpreaderSolution;      ///< 132     RDIMM
                                                                                                 ///< Thermal Heat
                                                                                                 ///< Spreader Solution
  SPD4_MANUFACTURER_ID_CODE                                    RegisterManufacturerIdCode;       ///< 133-134 Register
                                                                                                 ///< Manufacturer ID
                                                                                                 ///< Code
  SPD4_LRDIMM_REGISTER_REVISION_NUMBER                         RegisterRevisionNumber;           ///< 135     Register
                                                                                                 ///< Revision Number
  SPD4_LRDIMM_ADDRESS_MAPPING_FROM_REGISTER_TO_DRAM            AddressMappingFromRegisterToDram; ///< 136 Address
                                                                                                 ///< Mapping from
                                                                                                 ///< Register to DRAM
  SPD4_LRDIMM_REGISTER_OUTPUT_DRIVE_STRENGTH_FOR_CONTROL_COMMAND_ADDRESS
                                                               RegisterOutputDriveStrengthForControlCommandAddress; ///<
                                                                                                                    ///< 137
                                                                                                                    ///< Register
                                                                                                                    ///< Output
                                                                                                                    ///< Drive
  ...
  SPD4_LRDIMM_DATA_BUFFER_MDQ_DRIVE_STRENGTH_RTT_FOR_DATA_RATE
                                                               DataBufferMdqDriveStrengthRttForDataRateLe1866;        ///<
                                                                                                                      ...
                                                                                                                      ///< 1866
  SPD4_LRDIMM_DATA_BUFFER_MDQ_DRIVE_STRENGTH_RTT_FOR_DATA_RATE
                                                               DataBufferMdqDriveStrengthRttForDataRateLe2400;        ///<
                                                                                                                      ///< 146
                                                                                                                      ///< 
                                                                                                                      ///< 
                                                                                                                      ///< 
...
typedef struct {
  UINT8                                                         Reserved0[191 - 128 + 1];                   ///< 128-191
                                                                                                            ///<  Reserved
  SPD4_NVDIMM_MODULE_PRODUCT_IDENTIFIER                         ModuleProductIdentifier;                    ///< 192-193
                                                                                                            ///<  Module
                                                                                                            ///< Product
                                                                                                            ///< Identifier
  SPD4_NVDIMM_SUBSYSTEM_CONTROLLER_MANUFACTURER_ID_CODE         SubsystemControllerManufacturerIdCode;      ///< 194-195
                                                                                                            ///<  Subsystem
                                                                                                            ///< Controller
                                                                                                            ///< Manufacturer's
                                                                                                            ///< ID Code
  SPD4_NVDIMM_SUBSYSTEM_CONTROLLER_IDENTIFIER                   SubsystemControllerIdentifier;              ///< 196-197
                                                                                                            ///<  Subsystem
                                                                                                            ///< Controller
                                                                                                            ///< Identifier
  SPD4_NVDIMM_SUBSYSTEM_CONTROLLER_REVISION_CODE                SubsystemControllerRevisionCode;            ///< 198
                                                                                                            ///<   
                                                                                                            ///<   Subsystem
                                                                                                            ///< Controller
                                                                                                            ///< Revision
                                                                                                            ///< Code
  SPD4_NVDIMM_REFERENCE_RAW_CARD                                ReferenceRawCardUsed;                       ///< 199
                                                                                                            ///<   
                                                                                                            ///<   Reference
                                                                                                            ///< Raw
                                                                                                            ///< Card
                                                                                                            ///< Used
  SPD4_NVDIMM_MODULE_CHARACTERISTICS                            ModuleCharacteristics;                      ///< 200
                                                                                                            ///<   
                                                                                                            ///<   Module
                                                                                                            ///< Characteristics
  SPD4_NVDIMM_HYBRID_MODULE_MEDIA_TYPES                         HybridModuleMediaTypes;                     ///< 201-202
                                                                                                            ///<  Hybrid
                                                                                                            ///< Module
                                                                                                            ///< Media
                                                                                                            ///< Types
  SPD4_NVDIMM_MAXIMUM_NONVOLATILE_MEMORY_INITIALIZATION_TIME    MaximumNonVolatileMemoryInitializationTime; ///< 203
                                                                                                            ///< Maximum
                                                                                                            ///< Non-Volatile
                                                                                                            ///< Memory
                                                                                                            ///< Initialization
                                                                                                            ///< Time
  SPD4_NVDIMM_FUNCTION_INTERFACE_DESCRIPTOR                     FunctionInterfaceDescriptors[8];            ///< 204-219
                                                                                                            ///<  Function
                                                                                                            ///< Interface
                                                                                                            ///< Descriptors
  UINT8                                                         Reserved[253 - 220 + 1];                    ///< 220-253
                                                                                                            ///<  Reserved
  SPD4_CYCLIC_REDUNDANCY_CODE                                   Crc;                                        ///< 254-255
                                                                                                            ///<  Cyclical
                                                                                                            ///< Redundancy
...
typedef union {
  ...
  SPD4_MODULE_NVDIMM         NonVolatile;                       ///< 128-255 Non-Volatile (NVDIMM-N) Hybrid Memory
                                                                ///< Parameters
