...
typedef struct {
  UINT32      Signature;
  UINT32      HeaderLength;                           // Length of EDKII_SYSTEM_FIRMWARE_IMAGE_DESCRIPTOR, excluding
                                                      // NameString
  ...
  UINT32      PackageVersionNameStringOffset;                           // Offset from head, CHAR16 string including
                                                                        // NULL terminate char
  ...
  UINT64      ImageId;
  UINT32      ImageIdNameStringOffset;                           // Offset from head, CHAR16 string including NULL
                                                                 // terminate char
  UINT32      Version;
  UINT32      VersionNameStringOffset;                           // Offset from head, CHAR16 string including NULL
                                                                 // terminate char
  UINT8       Reserved2[4];
  UINT64      Size;
