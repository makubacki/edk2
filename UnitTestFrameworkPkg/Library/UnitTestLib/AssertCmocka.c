  ...
  )
{
  ...
  snprintf (
    TempStr,
    sizeof (TempStr),
    "UT_ASSERT_NOT_EQUAL(%s:%llx, %s:%llx)",
    DescriptionA,
    ValueA,
    DescriptionB,
    ValueB
