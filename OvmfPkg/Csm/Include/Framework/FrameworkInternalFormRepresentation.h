...
typedef struct {
  ...
  UINT16                         Key;       ///< The value to be passed to the caller to identify this particular
                                            ///< op-code.
...
typedef struct {
  ...
  UINT8                          MaxEntries;    ///< The maximum number of options in the ordered list (=size of
                                                ///< NVStore).
  STRING_REF                     Prompt;        ///< The string token for the prompt.
  STRING_REF                     Help;          ///< The string token for the context-help.
...
typedef struct {
  ...
  STRING_REF                     Prompt;        ///< The String Token for the Prompt.
  STRING_REF                     Help;          ///< The string Token for the context-help.
  UINT8                          Flags;         ///< This is included solely for purposes of interactive/dynamic
                                                ///< support.
  UINT16                         Key;           ///< The value to be passed to caller to identify this particular
                                                ///< op-code.
  UINT16                         Minimum;
  UINT16                         Maximum;
