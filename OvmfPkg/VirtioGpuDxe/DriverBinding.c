  ...
  )
{
  ...
  CHAR16  *VgpuDevName;
    ...
    if (RemainingDevicePath != NULL && IsDevicePathEnd (RemainingDevicePath)) {
      ...
      //
      DEBUG (
             (DEBUG_INFO, "%a: bound VirtIo=%p without producing GOP\n",
  ...
  //
  DEBUG (
         (DEBUG_INFO, "%a: produced GOP %a VirtIo=%p\n", __FUNCTION__,
  ...
  )
{
  ...
  switch (NumberOfChildren) {
    case 0:
      ...
      DEBUG (
             (DEBUG_INFO, "%a: unbinding GOP-less VirtIo=%p\n", __FUNCTION__,
              (VOID *) VgpuDev->VirtIo)
             );
    ...
    case 1:
      ...
      DEBUG (
             (DEBUG_INFO, "%a: destroying GOP under VirtIo=%p\n", __FUNCTION__,
              (VOID *) VgpuDev->VirtIo)
             );
