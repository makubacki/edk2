  ...
  )
{
  ...
  for (Index = 0; Index < Size; Index++) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_IFCONFIG6_INFO_MAC_ADDR_BODY
        ),
  ...
  )
{
  ...
  for (Index = 0; Index < PREFIXMAXLEN; Index = Index + 2) {
    if (!Short && (Index + 1 < PREFIXMAXLEN) && (Index % 2 == 0) &&
        (Ip->Addr[Index] == 0) && (Ip->Addr[Index + 1] == 0))
    {
      //
    ...
    if (Index < PREFIXMAXLEN - 1) {
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_IFCONFIG6_INFO_IP_ADDR_BODY
          ),
        gShellNetwork2HiiHandle,
        Ip->Addr[Index]
        );
  ...
  for (HandleIndex = 0; HandleIndex < HandleNum; HandleIndex++) {
    ...
    if (Status != EFI_BUFFER_TOO_SMALL) {
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_IFCONFIG6_ERR_IP6CFG_GETDATA
          ),
        gShellNetwork2HiiHandle,
        Status
        );
  ...
  )
{
  ...
  if (IsListEmpty (IfList)) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_IFCONFIG6_ERR_INVALID_INTERFACE
        ),
      gShellNetwork2HiiHandle
      );
  }
  ...
  while (Entry != IfList) {
    ...
    if (IfCb->Policy == Ip6ConfigPolicyAutomatic) {
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_IFCONFIG6_INFO_POLICY_AUTO
          ),
        gShellNetwork2HiiHandle
        );
    } else {
    ...
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_IFCONFIG6_INFO_DAD_TRANSMITS
        ),
      gShellNetwork2HiiHandle,
      IfCb->Xmits
      );
    ...
    if (IfCb->IfId != NULL) {
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_IFCONFIG6_INFO_INTERFACE_ID_HEAD
          ),
        gShellNetwork2HiiHandle
        );
    ...
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_IFCONFIG6_INFO_MAC_ADDR_HEAD
        ),
      gShellNetwork2HiiHandle
      );
    ...
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_IFCONFIG6_INFO_IP_ADDR_HEAD
        ),
      gShellNetwork2HiiHandle
      );
    ...
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_IFCONFIG6_INFO_DNS_ADDR_HEAD
        ),
      gShellNetwork2HiiHandle
      );
  ...
  )
{
  ...
  while (VarArg != NULL) {
      ...
      switch (CheckCode) {
        case VarCheckDuplicate:
          ShellPrintHiiEx (
            ...
            NULL,
            STRING_TOKEN (
              STR_IFCONFIG6_ERR_DUPLICATE_COMMAND
              ),
            gShellNetwork2HiiHandle,
            VarArg->Arg
            );
        ...
        case VarCheckConflict:
          ShellPrintHiiEx (
            ...
            NULL,
            STRING_TOKEN (
              STR_IFCONFIG6_ERR_CONFLICT_COMMAND
              ),
            gShellNetwork2HiiHandle,
            VarArg->Arg
            );
        ...
        case VarCheckUnknown:
          ShellPrintHiiEx (
            ...
            NULL,
            STRING_TOKEN (
              STR_IFCONFIG6_ERR_UNKNOWN_COMMAND
              ),
            gShellNetwork2HiiHandle,
            VarArg->Arg
            );
    ...
    if (StrCmp (VarArg->Arg, L"auto") == 0) {
      ...
      if (VarArg != NULL) {
        if (StrCmp (VarArg->Arg, L"host") == 0) {
          ShellPrintHiiEx (
            ...
            NULL,
            STRING_TOKEN (
              STR_IFCONFIG6_ERR_INVALID_IP_CONFIG
              ),
            gShellNetwork2HiiHandle,
            Status
            );
          ...
          ShellPrintHiiEx (
            ...
            NULL,
            STRING_TOKEN (
              STR_IFCONFIG6_ERR_INVALID_GW_CONFIG
              ),
            gShellNetwork2HiiHandle,
            Status
            );
          ...
          ShellPrintHiiEx (
            ...
            NULL,
            STRING_TOKEN (
              STR_IFCONFIG6_ERR_INVALID_DNS_CONFIG
              ),
            gShellNetwork2HiiHandle,
            Status
            );
      ...
      if (EFI_ERROR (Status)) {
        if (Status == EFI_INVALID_PARAMETER) {
          ...
          ShellPrintHiiEx (
            ...
            NULL,
            STRING_TOKEN (
              STR_IFCONFIG6_ERR_LACK_ARGUMENTS
              ),
            gShellNetwork2HiiHandle,
            L"host"
            );
      ...
      for ( Index = 0; Index < (UINTN)(AddrSize /
            ...
            Index++)
      {
        ...
        for (Index2 = 0; Index2 < IfInfo->AddressInfoCount; Index2++) {
          if (EFI_IP6_EQUAL (
                &IfInfo->AddressInfo[Index2].Address,
        ...
        if (!IsAddressSet) {
          ShellPrintHiiEx (
            ...
            NULL,
            STRING_TOKEN (
              STR_IFCONFIG6_ERR_ADDRESS_FAILED
              ),
            gShellNetwork2HiiHandle
            );
          IfConfig6PrintIpAddr (
  ...
  )
{
  ...
  switch (Private->OpCode) {
    ...
    case IfConfig6OpClear:
      ShellStatus = IfConfig6ClearInterfaceInfo (
                      &Private->IfList,
                      Private->IfName
                      );
      break;
    ...
    case IfConfig6OpSet:
      ShellStatus = IfConfig6SetInterfaceInfo (
                      &Private->IfList,
                      Private->VarArg
                      );
      break;
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_IFCONFIG6_ERR_INVALID_COMMAND
        ),
      gShellNetwork2HiiHandle,
      L"ifconfig6",
      ProblemParam
       ...
       (ShellCommandLineGetFlag (ParamPackage, L"-?"))))
  {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_IFCONFIG6_CONFLICT_OPTIONS
        ),
      gShellNetwork2HiiHandle
      );
    ShellStatus = SHELL_INVALID_PARAMETER;
  ...
  if (ShellCommandLineGetFlag (ParamPackage, L"-s")) {
    ...
    if (ValueStr == NULL) {
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_IFCONFIG6_ERR_LACK_INTERFACE
          ),
        gShellNetwork2HiiHandle
        );
      ShellStatus = SHELL_INVALID_PARAMETER;
    ...
    if ((Private->IfName == NULL) || (Private->VarArg == NULL)) {
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_IFCONFIG6_ERR_LACK_COMMAND
          ),
        gShellNetwork2HiiHandle
        );
      ShellStatus = SHELL_INVALID_PARAMETER;
