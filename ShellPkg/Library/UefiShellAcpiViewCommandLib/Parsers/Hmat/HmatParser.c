...
STATIC CONST ACPI_PARSER  HmatStructureHeaderParser[] = {
  { L"Type",     2, 0, NULL, NULL, (VOID **)&HmatStructureType,
    NULL,
    NULL },
  { L"Reserved", 2, 2, NULL, NULL, NULL,
    NULL,
    NULL },
  { L"Length",   4, 4, NULL, NULL,
    (VOID **)&HmatStructureLength, NULL,
    NULL }
};
...
STATIC CONST ACPI_PARSER  MemProximityDomainAttributeParser[] = {
  ...
  { L"Reserved",                    2, 10,
    ...
    NULL,
    NULL },
  { L"Proximity Dom for initiator", 4, 12,
    L"0x%x", NULL, NULL,
    NULL,
    NULL },
  { L"Proximity Dom for memory",    4, 16,
    L"0x%x", NULL, NULL,
    NULL,
    NULL },
  { L"Reserved",                    4, 20,
...
STATIC CONST ACPI_PARSER  SllbiParser[] = {
  ...
  { L"Flags",                         1, 8,
    L"0x%x", NULL,
    (VOID **)&SllbiFlags, NULL,
    NULL },
  { L"Data type",                     1, 9,
    L"0x%x", NULL,
    (VOID **)&SllbiDataType, NULL,
    NULL },
  { L"Min Transfer Size",             1, 10,
    L"%d", NULL, NULL,
    NULL,
    NULL },
  { L"Reserved",                      1, 11,
    ...
    NULL,
    NULL },
  { L"Initiator Proximity Dom Count", 4, 12,
    L"%d", NULL,
    (VOID **)&NumberInitiatorProximityDomain, NULL, NULL },
  { L"Target Proximity Dom Count",    4, 16,
    L"%d", NULL,
...
STATIC CONST ACPI_PARSER  MemSideCacheInfoParser[] = {
  ...
  { L"Length",                   4, 4,
    ...
    NULL, NULL,
    NULL },
  { L"Proximity Dom for memory", 4, 8,
    L"0x%x", NULL,
    NULL, NULL,
    NULL },
  { L"Reserved",                 4, 12,
    ...
    NULL, NULL,
    NULL },
  { L"Memory Side Cache Size",   8, 16,
    L"0x%lx", NULL,
    NULL, NULL,
    NULL },
  { L"Cache Attributes",         4, 24,
    NULL, DumpCacheAttributes,
    NULL,
