...
STATIC CONST ACPI_PARSER  FadtFlagParser[] = {
  ...
  { L"PCI_EXP_WAK",                          1,
    ...
    NULL, NULL,
    NULL },
  { L"USE_PLATFORM_CLOCK",                   1,
    15, L"%d", NULL,
    NULL, NULL,
    NULL },
  { L"S4_RTC_STS_VALID",                     1,
    16, L"%d", NULL,
    NULL, NULL,
    NULL },
  { L"REMOTE_POWER_ON_CAPABLE",              1,
    17, L"%d", NULL,
    NULL, NULL,
    NULL },
  { L"FORCE_APIC_CLUSTER_MODEL",             1,
    18, L"%d", NULL,
    NULL, NULL,
    NULL },
  { L"FORCE_APIC_PHYSICAL_DESTINATION_MODE", 1,
    19, L"%d", NULL,
    NULL, NULL,
    NULL },
  { L"HW_REDUCED_ACPI",                      1,
...
STATIC CONST ACPI_PARSER  FadtParser[] = {
  ...
  { L"X_GPE1_BLK",                 12,
    ...
    NULL,                          NULL,
    NULL },
  { L"SLEEP_CONTROL_REG",          12,
    244,                           NULL,
    DumpGas,
    NULL,
    NULL,
    NULL },
  { L"SLEEP_STATUS_REG",           12,
    256,
    NULL,
    DumpGas,
    NULL,
