  ...
  )
{
  ...
  if (FirstInfo) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_QUERYTABLE_NO_INFO
        ),
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SYSTEM_WAKEUP_TYPE
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_BASE_BOARD_FEATURE_FLAGS
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_BASE_BOARD_BOARD_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SYSTEM_CHASSIS_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  if (BIT (Type, 7) != 0) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_QUERYTABLE_CHASSIS_LOCK_PRESENT
        ),
      gShellDebug1HiiHandle
      );
  }
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SYSTEM_CHASSIS_STATUS
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SYSTEM_CHASSIS_SECURITY
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Status, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_PROC_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_PROC_UPDATE
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_PROC_CHARACTERISTICS
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_DETECTMETHOD
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_CORRECT_CAPABILITY
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_INTERLEAVE_SUPPORT
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_MEMORY_SPEED
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_REQUIRED_VOLTAGES
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_MODULE_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_MODULE_ERROR_STATUS
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Status, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_CACHE_SRAM_TYPE
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_CACHE_ERROR_CORRECTING
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_CACHE_SYSTEM_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_CACHE_ASSOCIATIVITY
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_PORT_CONNECTOR_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_PORT_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SYSTEM_SLOT_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SYSTEM_SLOT_DATA
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SYSTEM_SLOT_CURRENT_USAGE
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SYSTEM_SLOT_LENGTH
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SLOT_CHARACTERISTICS
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SLOT_CHARACTERISTICS_2
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_ONBOARD_DEVICE_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SYSTEM_EVENT_LOG_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_EVENT_LOG_VAR_DATA_FORMAT
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_POST_RESULTS_BITMAP
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_POST_RESULTS_SECOND_DWORD
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Key, Option);
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_SYSTEM_MANAGEMENT_TYPES
      ),
    gShellDebug1HiiHandle
    );
  ...
  if (SMType >= 0x80000000) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_QUERYTABLE_OEM_ASSIGNED
        ),
      gShellDebug1HiiHandle
      );
    ...
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_QUERYTABLE_RSVD_FOR_FUTURE_ASSIGN
        ),
      gShellDebug1HiiHandle
      );
    ...
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_QUERYTABLE_SYSTEM_MANAGEMENT_PROBE
        ),
      gShellDebug1HiiHandle
      );
  } else if (SMType >= 0x31) {
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_PHYS_MEM_ARRAY_LOCATION
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_PHYS_MEM_ARRAY_USE
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_PHYS_MEM_ARRAY_ERROR
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_DEVICE_FORM_FACTOR
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_DEVICE_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_DEVICE_TYPE_DETAIL
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_ERROR_INFO
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_ERROR_OP
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_POINTING_DEVICE_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_POINTING_DEVICE_INTERFACE
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_PORTABLE_BATT_DEV_CHEM
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Key, Option);
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_VOLTAGE_PROBE_LOC
      ),
    gShellDebug1HiiHandle
    );
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_VOLTAGE_PROBE_STATUS
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Status, Option);
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_COOLING_DEV_STATUS
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Status, Option);
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_COOLING_DEV_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Type, Option);
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_TEMP_PROBE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Status, Option);
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_ELEC_PROBE_STATUS
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Status, Option);
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_ELEC_PROBE_LOC
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Loc, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MANAGEMENT_DEV_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Key, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_MEM_CHANNEL_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Key, Option);
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_BMC_INTERFACE_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Key, Option);
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_QUERYTABLE_STRUCT_TYPE
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Key, Option);
