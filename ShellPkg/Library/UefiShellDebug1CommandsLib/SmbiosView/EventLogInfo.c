  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_ACCESS_METHOD
      ),
  ...
  switch (Key) {
    case 0:
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_SMBIOSVIEW_EVENTLOGINFO_ONE_EIGHT_BIT
          ),
        gShellDebug1HiiHandle
        );
      break;
    ...
    case 1:
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_SMBIOSVIEW_EVENTLOGINFO_TWO_EIGHT_BITS
          ),
        gShellDebug1HiiHandle
        );
      break;
    ...
    case 2:
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_SMBIOSVIEW_EVENTLOGINFO_ONE_SIXTEEN_BIT
          ),
        gShellDebug1HiiHandle
        );
      break;
    ...
    case 3:
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_SMBIOSVIEW_EVENTLOGINFO_MEM_MAPPED_PHYS
          ),
        gShellDebug1HiiHandle
        );
      break;
    ...
    case 4:
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_SMBIOSVIEW_EVENTLOGINFO_AVAIL_VIA_GENERAL
          ),
        gShellDebug1HiiHandle
        );
      break;
    ...
    default:
      if (Key <= 0x7f) {
        ShellPrintHiiEx (
          ...
          NULL,
          STRING_TOKEN (
            STR_SMBIOSVIEW_EVENTLOGINFO_AVAIL_FOR_FUTURE_ASSIGN
            ),
          gShellDebug1HiiHandle
          );
      } else {
        ShellPrintHiiEx (
          ...
          NULL,
          STRING_TOKEN (
            STR_SMBIOSVIEW_EVENTLOGINFO_BIOS_VENDOR_OEM
            ),
          gShellDebug1HiiHandle
          );
      }
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_LOG_STATUS
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Key, Option);
  ...
  if ((Key & 0x01) != 0) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_EVENTLOGINFO_LOG_AREA_VALID
        ),
      gShellDebug1HiiHandle
      );
  } else {
  ...
  if ((Key & 0x02) != 0) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_EVENTLOGINFO_LOG_AREA_FULL
        ),
      gShellDebug1HiiHandle
      );
  } else {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_EVENTLOGINFO_LOG_AREA_NOT_FULL
        ),
      gShellDebug1HiiHandle
      );
  }
  ...
  if ((Key & 0xFC) != 0) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_EVENTLOGINFO_RES_BITS_NOT_ZERO
        ),
      gShellDebug1HiiHandle,
      Key &
      0xFC
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_LOG_HEADER_FORMAT
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Key, Option);
  ...
  if (Key == 0x00) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_EVENTLOGINFO_NO_HEADER
        ),
      gShellDebug1HiiHandle
      );
  } else if (Key == 0x01) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_EVENTLOGINFO_TYPE_LOG_HEADER
        ),
      gShellDebug1HiiHandle
      );
  } else if (Key <= 0x7f) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_EVENTLOGINFO_AVAIL_FOR_FUTURE
        ),
      gShellDebug1HiiHandle
      );
  } else {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_EVENTLOGINFO_BIOS_VENDOR
        ),
      gShellDebug1HiiHandle
      );
  }
  ...
  )
{
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_LOG_HEADER_LEN
      ),
    gShellDebug1HiiHandle
    );
  PRINT_INFO_OPTION (Key, Option);
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_ONE_VAR_D
      ),
    gShellDebug1HiiHandle,
    Key & 0x7F
    );
  ...
  if ((Key & 0x80) != 0) {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_EVENTLOGINFO_THIS_RECORD_READ
        ),
      gShellDebug1HiiHandle
      );
  } else {
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_EVENTLOGINFO_THIS_RECORD_NOT_READ
        ),
      gShellDebug1HiiHandle
      );
  }
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_SYSTEM_EVENT_LOG
      ),
    gShellDebug1HiiHandle
    );
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_MULTIPLE_EVENT_TIME
      ),
    gShellDebug1HiiHandle,
    Header->Metw
    );
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_MULTIPLE_EVENT_COUNT
      ),
    gShellDebug1HiiHandle,
    Header->Meci
    );
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_PREBOOT_ADDRESS
      ),
    gShellDebug1HiiHandle,
    Header->CMOSAddress
    );
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_PREBOOT_INDEX
      ),
    gShellDebug1HiiHandle,
    Header->CMOSBitIndex
    );
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_CHECKSUM_STARTING_OFF
      ),
    gShellDebug1HiiHandle,
    Header->StartingOffset
    );
  ShellPrintHiiEx (
    -1,
    -1,
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_CHECKSUN_BYTE_COUNT
      ),
    gShellDebug1HiiHandle,
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_HEADER_REVISION
      ),
    gShellDebug1HiiHandle,
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_LOG_HEADER
      ),
    gShellDebug1HiiHandle
    );
  ...
  if (LogHeaderFormat == 0x00) {
    ...
    ShellPrintHiiEx (
      ...
      NULL,
      STRING_TOKEN (
        STR_SMBIOSVIEW_EVENTLOGINFO_AVAIL_FUTURE_ASSIGN
        ),
      gShellDebug1HiiHandle
      );
  } else {
  ...
  switch (ElVdfType) {
    case 0:
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_SMBIOSVIEW_EVENTLOGINFO_NO_STD_FORMAT
          ),
        gShellDebug1HiiHandle
        );
      break;
    ...
    case 1:
      ...
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_SMBIOSVIEW_EVENTLOGINFO_SMBIOS_STRUCT_ASSOC
          ),
        gShellDebug1HiiHandle
        );
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_SMBIOSVIEW_EVENTLOGINFO_STRUCT_HANDLE
          ),
        gShellDebug1HiiHandle,
        *Word
        );
    ...
    case 2:
      ...
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_SMBIOSVIEW_EVENTLOGINFO_MULT_EVENT_COUNTER
          ),
        gShellDebug1HiiHandle,
        *Dword
        );
    ...
    default:
      if (ElVdfType <= 0x7F) {
        ShellPrintHiiEx (
          ...
          NULL,
          STRING_TOKEN (
            STR_SMBIOSVIEW_EVENTLOGINFO_UNUSED_AVAIL_FOR_ASSIGN
            ),
          gShellDebug1HiiHandle
          );
      } else {
        ShellPrintHiiEx (
          ...
          NULL,
          STRING_TOKEN (
            STR_SMBIOSVIEW_EVENTLOGINFO_AVAIL_FOR_SYSTEM
            ),
          gShellDebug1HiiHandle
          );
      }
  ...
  )
{
  ...
  ShellPrintHiiEx (
    ...
    NULL,
    STRING_TOKEN (
      STR_SMBIOSVIEW_EVENTLOGINFO_SYSTEM_EVENT_LOG_2
      ),
    gShellDebug1HiiHandle
    );
  ...
  while (Log != NULL && Log->Type != END_OF_LOG && Offset < LogAreaLength) {
    if (Log != NULL) {
      ...
      ShellPrintHiiEx (
        ...
        NULL,
        STRING_TOKEN (
          STR_SMBIOSVIEW_EVENTLOGINFO_DATE
          ),
        gShellDebug1HiiHandle
        );
      if ((Log != NULL) && (Log->Year >= 80) && (Log->Year <= 99)) {
        ...
        ShellPrintHiiEx (
          ...
          NULL,
          STRING_TOKEN (
            STR_SMBIOSVIEW_EVENTLOGINFO_ERROR
            ),
          gShellDebug1HiiHandle
          );
        //
