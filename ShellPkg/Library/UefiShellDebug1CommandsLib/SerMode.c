  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    ...
    if ((ShellCommandLineGetCount (Package) < 6) && (ShellCommandLineGetCount (
                                                       Package
                                                       ) > 2))
    {
      ShellPrintHiiEx (
