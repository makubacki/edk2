  ...
  )
{
  ...
  switch (Memory) {
    case EfiReservedMemoryType:       StrnCatGrow (
                                        &RetVal,
                                        NULL,
      ...
      break;
    case EfiLoaderCode:               StrnCatGrow (
                                        &RetVal,
                                        NULL,
                                        L"EfiLoaderCode",
                                        0
      ...
      break;
    case EfiLoaderData:               StrnCatGrow (
                                        &RetVal,
                                        NULL,
                                        L"EfiLoaderData",
                                        0
      ...
      break;
    case EfiBootServicesCode:         StrnCatGrow (
                                        &RetVal,
                                        NULL,
      ...
      break;
    case EfiBootServicesData:         StrnCatGrow (
                                        &RetVal,
                                        NULL,
      ...
      break;
    case EfiRuntimeServicesCode:      StrnCatGrow (
                                        &RetVal,
                                        NULL,
      ...
      break;
    case EfiRuntimeServicesData:      StrnCatGrow (
                                        &RetVal,
                                        NULL,
      ...
      break;
    case EfiConventionalMemory:       StrnCatGrow (
                                        &RetVal,
                                        NULL,
      ...
      break;
    case EfiUnusableMemory:           StrnCatGrow (
                                        &RetVal,
                                        NULL,
                                        L"EfiUnusableMemory",
                                        0
      ...
      break;
    case EfiACPIReclaimMemory:        StrnCatGrow (
                                        &RetVal,
                                        NULL,
      ...
      break;
    case EfiACPIMemoryNVS:            StrnCatGrow (
                                        &RetVal,
                                        NULL,
                                        L"EfiACPIMemoryNVS",
                                        0
      ...
      break;
    case EfiMemoryMappedIO:           StrnCatGrow (
                                        &RetVal,
                                        NULL,
                                        L"EfiMemoryMappedIO",
                                        0
      ...
      break;
    case EfiMemoryMappedIOPortSpace:  StrnCatGrow (
                                        &RetVal,
                                        NULL,
    ...
    case EfiPalCode:                  StrnCatGrow (
      ...
      break;
    case EfiMaxMemoryType:            StrnCatGrow (
                                        &RetVal,
                                        NULL,
                                        L"EfiMaxMemoryType",
                                        0
  ...
  )
{
  ...
  switch (Fmt) {
    case PixelRedGreenBlueReserved8BitPerColor: StrnCatGrow (
                                                  &RetVal,
                                                  NULL,
      ...
      break;
    case PixelBlueGreenRedReserved8BitPerColor: StrnCatGrow (
                                                  &RetVal,
                                                  NULL,
    ...
    case PixelBltOnly:                          StrnCatGrow (
      ...
      break;
    case PixelFormatMax:                        StrnCatGrow (
                                                  &RetVal,
                                                  NULL,
                                                  L"PixelFormatMax",
                                                  0
  ...
  )
{
  if (mHandleParsingHiiHandle == NULL) {
    mHandleParsingHiiHandle = HiiAddPackages (
  ...
  )
{
  ...
  for (LoopCount = 0; mGuidList != NULL && LoopCount < mGuidListCount;
       LoopCount++)
  {
  ...
  )
{
  ...
  RetVal = CatSPrint (
             ...
             GraphicsOutput->Mode->Info->PixelFormat != PixelBitMask ? 0 :
  ...
  )
{
  ...
  Supports   = 0;
  Attributes = 0;
  Status     = PciRootBridgeIo->GetAttributes (
                                  PciRootBridgeIo,
                                  &Supports,
                                  &Attributes
                                  );
...
{
  return DevicePathProtocolDumpInformationEx (
           TheHandle,
           Verbose,
  ...
  )
{
  ...
  switch (DebugSupport->Isa) {
    ...
    default:
      ...
      RetVal = GetString != NULL ? CatSPrint (
                                     RetVal,
                                     GetString,
                                     DebugSupport->Isa
                                     ) : NULL;
  ...
  )
{
  ...
  RetVal = NULL;
  if (EFI_ERROR (Status)) {
    TempStr = HiiGetString (
                mHandleParsingHiiHandle,
                STRING_TOKEN (
                  STR_GET_SUPP_TYPES_FAILED
                  ),
                NULL
                );
    if (TempStr != NULL) {
    ...
    for (GuidIndex = 0; GuidIndex < InfoTypesBufferCount; GuidIndex++) {
            ...
            ))
      {
        TempRetVal = CatSPrint (
                       RetVal,
                       TempStr,
                       L"gEfiAdapterInfoMediaStateGuid"
                       );
        SHELL_FREE_NON_NULL (RetVal);
        RetVal = TempRetVal;
      } else if (CompareGuid (
      ...
      if (EFI_ERROR (Status)) {
              ...
              ))
        {
          ...
          TempRetVal = CatSPrint (
                         RetVal,
                         TempStr,
                         ((EFI_ADAPTER_INFO_MEDIA_STATE *)InformationBlock)->
                           MediaState,
                         ((EFI_ADAPTER_INFO_MEDIA_STATE *)InformationBlock)->
                           MediaState
                         );
                     ...
                     ))
        {
          ...
          TempRetVal = CatSPrint (
                         RetVal,
                         TempStr,
                         ((EFI_ADAPTER_INFO_NETWORK_BOOT *)InformationBlock)->
                     ...
                     ) == TRUE)
        {
          ...
          TempRetVal = CatSPrint (
                         RetVal,
                         TempStr,
                         ((EFI_ADAPTER_INFO_SAN_MAC_ADDRESS *)InformationBlock)
                           ->SanMacAddress.Addr[0],
                         ((EFI_ADAPTER_INFO_SAN_MAC_ADDRESS *)InformationBlock)
                           ->SanMacAddress.Addr[1],
                         ((EFI_ADAPTER_INFO_SAN_MAC_ADDRESS *)InformationBlock)
                           ->SanMacAddress.Addr[2],
                         ((EFI_ADAPTER_INFO_SAN_MAC_ADDRESS *)InformationBlock)
                           ->SanMacAddress.Addr[3],
                         ((EFI_ADAPTER_INFO_SAN_MAC_ADDRESS *)InformationBlock)
                           ->SanMacAddress.Addr[4],
                         ((EFI_ADAPTER_INFO_SAN_MAC_ADDRESS *)InformationBlock)
                           ->SanMacAddress.Addr[5]
                         );
          SHELL_FREE_NON_NULL (RetVal);
          RetVal = TempRetVal;
        } else if (CompareGuid (
                     ...
                     ) == TRUE)
        {
          ...
          TempRetVal = CatSPrint (
                         RetVal,
                         TempStr,
                         ((EFI_ADAPTER_INFO_UNDI_IPV6_SUPPORT *)InformationBlock)
                           ->Ipv6Support
                         );
          SHELL_FREE_NON_NULL (RetVal);
          RetVal = TempRetVal;
    ...
    for (Index = 0; Index < DescriptorCount; Index++) {
      ...
      if (!AttributeSupported) {
        ...
        if ((AttributeSetting & IMAGE_ATTRIBUTE_IMAGE_UPDATABLE) != 0x0) {
          TempRetVal = CatSPrint (
                         AttributeSettingStr,
                         L" IMAGE_ATTRIBUTE_IMAGE_UPDATABLE"
                         );
          SHELL_FREE_NON_NULL (AttributeSettingStr);
        ...
        if ((AttributeSetting & IMAGE_ATTRIBUTE_RESET_REQUIRED) != 0x0) {
          TempRetVal = CatSPrint (
                         AttributeSettingStr,
                         L" IMAGE_ATTRIBUTE_RESET_REQUIRED"
                         );
          SHELL_FREE_NON_NULL (AttributeSettingStr);
          AttributeSettingStr = TempRetVal;
        }
      ...
      if (DescriptorVersion == EFI_FIRMWARE_IMAGE_DESCRIPTOR_VERSION_V1) {
        ...
        TempStr = HiiGetString (
                    mHandleParsingHiiHandle,
                    STRING_TOKEN (
                      STR_FMP_IMAGE_DESCRIPTOR_INFO_V1
                      ),
                    NULL
                    );
        if (TempStr == NULL) {
                 ...
                 EFI_FIRMWARE_IMAGE_DESCRIPTOR_VERSION_V2)
      {
        ...
        TempStr = HiiGetString (
                    mHandleParsingHiiHandle,
                    STRING_TOKEN (
                      STR_FMP_IMAGE_DESCRIPTOR_INFO_V2
                      ),
                    NULL
                    );
        if (TempStr == NULL) {
  ...
  )
{
  ...
  switch (PartitionInfo->Type) {
    case PARTITION_TYPE_OTHER:
      PartitionType = HiiGetString (
                        mHandleParsingHiiHandle,
                        STRING_TOKEN (
                          STR_PARTINFO_DUMP_TYPE_OTHER
                          ),
                        NULL
                        );
      break;
  ...
  if (PartitionInfo->System == 1) {
    EfiSystemPartition = HiiGetString (
                           mHandleParsingHiiHandle,
                           STRING_TOKEN (
                             STR_PARTINFO_DUMP_EFI_SYS_PART
                             ),
                           NULL
                           );
  } else {
    EfiSystemPartition = HiiGetString (
                           mHandleParsingHiiHandle,
                           STRING_TOKEN (
                             STR_PARTINFO_DUMP_NOT_EFI_SYS_PART
                             ),
                           NULL
                           );
  }
...
STATIC CONST EFI_GUID  WinNtThunkProtocolGuid =
...
STATIC CONST GUID_INFO_BLOCK  mGuidStringListNT[] = {
  { STRING_TOKEN (STR_WINNT_THUNK),       (EFI_GUID *)&WinNtThunkProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_WINNT_DRIVER_IO),   (EFI_GUID *)&WinNtIoProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_WINNT_SERIAL_PORT), (EFI_GUID *)&WinNtSerialPortGuid,
    NULL },
  { 0,                                    NULL,
    NULL },
};
...
STATIC CONST GUID_INFO_BLOCK  mGuidStringList[] = {
  ...
  { STRING_TOKEN (STR_DEVICE_PATH_FTXT),    &gEfiDevicePathFromTextProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DEVICE_PATH_PC),      &gEfiPcAnsiGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_DRIVER_DIAG2),        &gEfiDriverDiagnostics2ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DRIVER_CN),           &gEfiComponentNameProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DRIVER_CN2),          &gEfiComponentName2ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_PLAT_DRV_CFG),
    &gEfiPlatformToDriverConfigurationProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DRIVER_VERSION),
    &gEfiDriverSupportedEfiVersionProtocolGuid,
    DriverEfiVersionProtocolDumpInformation },
  { STRING_TOKEN (STR_TXT_IN),              &gEfiSimpleTextInProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_TXT_IN_EX),           &gEfiSimpleTextInputExProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_TXT_OUT),             &gEfiSimpleTextOutProtocolGuid,
    TxtOutProtocolDumpInformation },
  { STRING_TOKEN (STR_SIM_POINTER),         &gEfiSimplePointerProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_CON_OUT),             &gEfiConsoleOutDeviceGuid,
    NULL },
  { STRING_TOKEN (STR_STD_ERR),             &gEfiStandardErrorDeviceGuid,
    NULL },
  { STRING_TOKEN (STR_LOAD_FILE),           &gEfiLoadFileProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_LOAD_FILE2),          &gEfiLoadFile2ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_SIMPLE_FILE_SYS),     &gEfiSimpleFileSystemProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_TAPE_IO),             &gEfiTapeIoProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DISK_IO),             &gEfiDiskIoProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_BLK_IO),              &gEfiBlockIoProtocolGuid,
    BlockIoProtocolDumpInformation },
  { STRING_TOKEN (STR_UC),                  &gEfiUnicodeCollationProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_UC2),                 &gEfiUnicodeCollation2ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_PCIRB_IO),            &gEfiPciRootBridgeIoProtocolGuid,
    PciRootBridgeIoDumpInformation },
  { STRING_TOKEN (STR_PCI_IO),              &gEfiPciIoProtocolGuid,
    PciIoProtocolDumpInformation },
  { STRING_TOKEN (STR_SCSI_PT),             &gEfiScsiPassThruProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_SCSI_IO),             &gEfiScsiIoProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_SCSI_PT_EXT),         &gEfiExtScsiPassThruProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_ISCSI),               &gEfiIScsiInitiatorNameProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_USB_IO),              &gEfiUsbIoProtocolGuid,
    UsbIoProtocolDumpInformation },
  { STRING_TOKEN (STR_USB_HC),              &gEfiUsbHcProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_USB_HC2),             &gEfiUsb2HcProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DEBUG_SUPPORT),       &gEfiDebugSupportProtocolGuid,
    DebugSupportProtocolDumpInformation },
  { STRING_TOKEN (STR_DEBUG_PORT),          &gEfiDebugPortProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DECOMPRESS),          &gEfiDecompressProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_ACPI_TABLE),          &gEfiAcpiTableProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_EBC_INTERPRETER),     &gEfiEbcProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_SNP),                 &gEfiSimpleNetworkProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_NII),
    &gEfiNetworkInterfaceIdentifierProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_NII_31),
    &gEfiNetworkInterfaceIdentifierProtocolGuid_31,
    NULL },
  { STRING_TOKEN (STR_PXE_BC),              &gEfiPxeBaseCodeProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_PXE_CB),
    &gEfiPxeBaseCodeCallbackProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_BIS),                 &gEfiBisProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_MNP_SB),
    &gEfiManagedNetworkServiceBindingProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_MNP),                 &gEfiManagedNetworkProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_ARP_SB),              &gEfiArpServiceBindingProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_ARP),                 &gEfiArpProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DHCPV4_SB),
    &gEfiDhcp4ServiceBindingProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DHCPV4),              &gEfiDhcp4ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_TCPV4_SB),            &gEfiTcp4ServiceBindingProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_TCPV4),               &gEfiTcp4ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_IPV4_SB),             &gEfiIp4ServiceBindingProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_AUTH_INFO),           &gEfiAuthenticationInfoProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_HASH_SB),             &gEfiHashServiceBindingProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_HASH),                &gEfiHashProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_HII_FONT),            &gEfiHiiFontProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_HII_STRING),          &gEfiHiiStringProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_HII_IMAGE),           &gEfiHiiImageProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_HII_DATABASE),        &gEfiHiiDatabaseProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_HII_FORM_BROWSER2),   &gEfiFormBrowser2ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DRIVER_FAM_OVERRIDE),
    &gEfiDriverFamilyOverrideProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_PCD),                 &gPcdProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_TCG),                 &gEfiTcgProtocolGuid,
    NULL },
  ...
  //
  { STRING_TOKEN (STR_SHELL_INTERFACE),     &gEfiShellInterfaceGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_ISA_IO),              (EFI_GUID *)&EfiIsaIoProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_ISA_ACPI),            (EFI_GUID *)&EfiIsaAcpiProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_FILE_INFO),           &gEfiFileInfoGuid,
    NULL },
  { STRING_TOKEN (STR_FILE_SYS_INFO),       &gEfiFileSystemInfoGuid,
    NULL },

  //
  // the ones under this are misc GUIDS.
  //
  { STRING_TOKEN (STR_EFI_GLOBAL_VARIABLE), &gEfiGlobalVariableGuid,
    NULL },

  //
  // UEFI 2.2
  //
  { STRING_TOKEN (STR_IP6_SB),              &gEfiIp6ServiceBindingProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_IP6),                 &gEfiIp6ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_IP6_CONFIG),          &gEfiIp6ConfigProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_MTFTP6_SB),
    &gEfiMtftp6ServiceBindingProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_MTFTP6),              &gEfiMtftp6ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DHCP6_SB),
    &gEfiDhcp6ServiceBindingProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DHCP6),               &gEfiDhcp6ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_UDP6_SB),             &gEfiUdp6ServiceBindingProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_UDP6),                &gEfiUdp6ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_TCP6_SB),             &gEfiTcp6ServiceBindingProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_TCP6),                &gEfiTcp6ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_VLAN_CONFIG),         &gEfiVlanConfigProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_EAP),                 &gEfiEapProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_EAP_MGMT),            &gEfiEapManagementProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_FTP4_SB),             &gEfiFtp4ServiceBindingProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_FTP4),                &gEfiFtp4ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_IP_SEC_CONFIG),       &gEfiIpSecConfigProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DH),                  &gEfiDriverHealthProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DEF_IMG_LOAD),        &gEfiDeferredImageLoadProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_USER_CRED),           &gEfiUserCredentialProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_USER_MNGR),           &gEfiUserManagerProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_ATA_PASS_THRU),       &gEfiAtaPassThruProtocolGuid,
    NULL },

  //
  // UEFI 2.3
  //
  { STRING_TOKEN (STR_FW_MGMT),             &gEfiFirmwareManagementProtocolGuid,
    FirmwareManagementDumpInformation },
  { STRING_TOKEN (STR_IP_SEC),              &gEfiIpSecProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_IP_SEC2),             &gEfiIpSec2ProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_DISK_IO2),            &gEfiDiskIo2ProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_ADAPTER_INFO),        &gEfiAdapterInformationProtocolGuid,
    AdapterInformationDumpInformation },

  //
  // UEFI2.5
  //
  { STRING_TOKEN (STR_TLS_SB),              &gEfiTlsServiceBindingProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_MON_ARCH),
    ...
    NULL },
  { STRING_TOKEN (STR_RTC_ARCH),            &gEfiRealTimeClockArchProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_TIMER_ARCH),          &gEfiTimerArchProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_VAR_ARCH),            &gEfiVariableWriteArchProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_V_ARCH),              &gEfiVariableArchProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_SECP),                &gEfiSecurityPolicyProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_WDT_ARCH),            &gEfiWatchdogTimerArchProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_SCR),                 &gEfiStatusCodeRuntimeProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_PCIHPI),              &gEfiPciHotPlugInitProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_PCIHPR),              &gEfiPciHotPlugRequestProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_S_RTL),               &gEfiSmmReadyToLockProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_DS_RTL),              &gEfiDxeSmmReadyToLockProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_S_PBD2),
    ...
    NULL },
  { STRING_TOKEN (STR_S_ITD2),              &gEfiSmmIoTrapDispatch2ProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_RNG),                 &gEfiRngProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_NVMEPT),              &gEfiNvmExpressPassThruProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_BC_C),                &gEfiBluetoothConfigProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_REG_EXP),             &gEfiRegularExpressionProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_B_MGR_P),             &gEfiBootManagerPolicyProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_MM_SWD),              &gEfiMmSwDispatchProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_MM_PRBI),             &gEfiMmPciRootBridgeIoProtocolGuid,
    NULL },
  ...
  { STRING_TOKEN (STR_MM_RH),               &gEfiMmRscHandlerProtocolGuid,
    NULL },
  { STRING_TOKEN (STR_MM_COM),              &gEfiMmCommunicationProtocolGuid,
    NULL },
  ...
  )
{
  ...
  for (LoopCount = 0, ListWalker = mGuidList; mGuidList != NULL && LoopCount <
       mGuidListCount; LoopCount++, ListWalker++)
  {
  ...
  if (PcdGetBool (PcdShellIncludeNtGuids)) {
    for (ListWalker = mGuidStringListNT; ListWalker != NULL &&
         ListWalker->GuidId != NULL; ListWalker++)
    {
      if (CompareGuid (ListWalker->GuidId, Guid)) {
        return (ListWalker);
      }
  ...
  for (ListWalker = mGuidStringList; ListWalker != NULL && ListWalker->GuidId !=
       NULL; ListWalker++)
  {
    if (CompareGuid (ListWalker->GuidId, Guid)) {
      return (ListWalker);
  ...
  )
{
  ...
  mGuidList[mGuidListCount - 1].GuidId = AllocateCopyPool (
                                           sizeof (EFI_GUID),
                                           Guid
                                           );
  ...
  *Guid = NULL;
  ...
  if (PcdGetBool (PcdShellIncludeNtGuids)) {
         ...
         ListWalker->GuidId != NULL; ListWalker++)
    {
      ...
      if ((Name != NULL) && (String != NULL) && (StringNoCaseCompare (
                                                   &Name,
                                                   &String
                                                   ) == 0))
      {
  ...
  )
{
  ...
  if (!EFI_ERROR (Status)) {
    BestLang = GetBestLanguageForDriver (
                 CompNameStruct->SupportedLanguages,
                 Language,
                 FALSE
                 );
    Status = CompNameStruct->GetDriverName (
                               CompNameStruct,
                               BestLang,
                               &RetVal
                               );
  ...
  )
{
  ...
  for (ListWalker = (HANDLE_LIST *)GetFirstNode (&mHandleList.List.Link)
       ...
       ; ListWalker = (HANDLE_LIST *)GetNextNode (
                                       &mHandleList.List.Link,
                                       &ListWalker->Link
                                       )
       )
  {
  ...
  )
{
  ...
  *HandleType = AllocateZeroPool (*HandleCount * sizeof (UINTN));
  ...
  for (HandleIndex = 0; HandleIndex < *HandleCount; HandleIndex++) {
    if ((DriverBindingHandle != NULL) && ((*HandleBuffer)[HandleIndex] ==
                                          DriverBindingHandle))
    {
             ...
             OpenInfoIndex++)
        {
               ...
               0))
          {
            ...
            if (DriverBindingHandleIndex != -1) {
              (*HandleType)[DriverBindingHandleIndex] |=
                ...
                EFI_OPEN_PROTOCOL_BY_CHILD_CONTROLLER) != 0))
          {
            (*HandleType)[HandleIndex] |= (UINTN)(HR_DEVICE_HANDLE |
                                                  HR_CONTROLLER_HANDLE);
            if (DriverBindingHandleIndex != -1) {
              (*HandleType)[DriverBindingHandleIndex] |= (UINTN)(HR_BUS_DRIVER |
                                                                 HR_DEVICE_DRIVER);
            }

            for (ChildIndex = 0; ChildIndex < *HandleCount; ChildIndex++) {
              if (OpenInfo[OpenInfoIndex].ControllerHandle ==
                  (*HandleBuffer)[ChildIndex])
              {
                (*HandleType)[ChildIndex] |= (UINTN)(HR_DEVICE_HANDLE |
                                                     HR_CHILD_HANDLE);
              }
            }
          }
      ...
      if ((DriverBindingHandle == NULL) && (ControllerHandle != NULL)) {
        if (ControllerHandle == (*HandleBuffer)[HandleIndex]) {
               ...
               OpenInfoIndex++)
          {
            ...
            {
              for (ChildIndex = 0; ChildIndex < *HandleCount; ChildIndex++) {
                if (OpenInfo[OpenInfoIndex].AgentHandle ==
                    (*HandleBuffer)[ChildIndex])
                {
                 ...
                 EFI_OPEN_PROTOCOL_BY_CHILD_CONTROLLER) != 0)
            {
              for (ChildIndex = 0; ChildIndex < *HandleCount; ChildIndex++) {
                if (OpenInfo[OpenInfoIndex].AgentHandle ==
                    (*HandleBuffer)[ChildIndex])
                {
                  (*HandleType)[ChildIndex] |= (UINTN)(HR_BUS_DRIVER |
                                                       HR_DEVICE_DRIVER);
                }
  ...
  if (!EFI_ERROR (Status)) {
    ...
    if (*MatchingHandleCount == 0) {
      ...
      if (MatchingHandleBuffer == NULL) {
        ...
        //
        *MatchingHandleBuffer = AllocateZeroPool (
                                  (*MatchingHandleCount +1)*
                                  sizeof (EFI_HANDLE)
                                  );
        if (*MatchingHandleBuffer == NULL) {
          Status = EFI_OUT_OF_RESOURCES;
  ...
  )
{
  ...
  *MatchingHandleCount = 0;
  ...
  for (DriverBindingHandleIndex = 0; DriverBindingHandleIndex <
       DriverBindingHandleCount; DriverBindingHandleIndex++)
  {
         ...
         )
    {
      for (HandleIndex = 0; HandleIndex < *MatchingHandleCount; HandleIndex++) {
        if (HandleBufferForReturn[HandleIndex] ==
      ...
      if (HandleIndex >= *MatchingHandleCount) {
        HandleBufferForReturn[(*MatchingHandleCount)++] =
          ChildControllerHandleBuffer[ChildControllerHandleIndex];
      }
    }
  ...
  )
{
  ...
  if (LocalDestinationSize == 0) {
    ...
    *DestinationBuffer = AllocateZeroPool (LocalDestinationFinalSize);
    ...
    // reallocate
    *DestinationBuffer = ReallocatePool (
  ...
  // copy
  return (CopyMem (
            ((UINT8 *)(*DestinationBuffer)) + LocalDestinationSize,
            SourceBuffer,
            SourceSize
            ));
}
  ...
  if (!EFI_ERROR (Status)) {
    for (HandleIndex = 0; HandleIndex < Count1; HandleIndex++) {
      ...
      *MatchingHandleCount += Count2;
      if (MatchingHandleBuffer != NULL) {
        *MatchingHandleBuffer = BuffernCatGrow (
  ...
  )
{
  ...
  for (GuidWalker = ProtocolGuids; GuidWalker != NULL && *GuidWalker != NULL;
       GuidWalker++, Size = 0)
  {
    Status = gBS->LocateHandle (
                    ByProtocol,
       ...
       GuidWalker++)
  {
    ...
    Status   = gBS->LocateHandle (
                      ...
                      NULL,
                      &TempSize,
                      HandleList+(Size/sizeof (EFI_HANDLE))
                      );
  ...
  for (HandleWalker1 = HandleList; HandleWalker1 != NULL && *HandleWalker1 !=
       NULL; HandleWalker1++)
  {
    for (HandleWalker2 = HandleWalker1 + 1; HandleWalker2 != NULL &&
         *HandleWalker2 != NULL; HandleWalker2++)
    {
