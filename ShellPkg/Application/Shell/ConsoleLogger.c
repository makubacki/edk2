  ...
  for ( Walker = String
    ...
    switch (*Walker) {
      ...
      case (CHAR_LINEFEED):
        if (ConsoleInfo->HistoryMode.CursorRow >= (INT32)((ConsoleInfo->RowsPerScreen * ConsoleInfo->ScreenCount)-1)) {
          ...
          for ( Index = 0
            ...
            *(ConsoleInfo->Attributes + (CopySize/sizeof (ConsoleInfo->Attributes[0])) +
              Index) = ConsoleInfo->HistoryMode.Attribute;
          }
          ...
          if (ConsoleInfo->HistoryMode.CursorRow ==
              (INT32)(ConsoleInfo->OriginalStartRow + ConsoleInfo->RowsPerScreen - 1)) {
      ...
      default:
        ...
        PrintIndex = ConsoleInfo->HistoryMode.CursorRow * ConsoleInfo->ColsPerScreen +
                     ConsoleInfo->HistoryMode.CursorColumn;
  ...
  )
{
  ...
  ConsoleInfo->BufferSize = (ConsoleInfo->ColsPerScreen + 2) * ConsoleInfo->RowsPerScreen * ConsoleInfo->ScreenCount *
                            sizeof (ConsoleInfo->Buffer[0]);
  ConsoleInfo->AttribSize = ConsoleInfo->ColsPerScreen * ConsoleInfo->RowsPerScreen * ConsoleInfo->ScreenCount *
                            sizeof (ConsoleInfo->Attributes[0]);
