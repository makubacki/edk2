  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
            ...
            )
    {
      ...
      if (((Measurement.EndTimeStamp != 0) && (ElapsedTime <
                                               mInterestThreshold)) ||
